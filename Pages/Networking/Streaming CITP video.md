...
next_page: "[Pages/Networking/Thumbnail exchange](Thumbnail%20exchange.md)"
depth: 3
tags:
  - "type/page"
  - "section/network"
...
This video stream can be viewed on the MA console and onPC in the **CITP Video Viewer** window - create it using the [Create Basic Windows](../../Sections/Windows.md).
...
Make sure the CITP is activated in the console/onPC. Have a look at the [Using CITP](Using%20CITP.md) topic.
