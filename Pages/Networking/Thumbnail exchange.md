...
prev_page: "[Pages/Networking/Streaming CITP video](Streaming%20CITP%20video.md)"
depth: 3
tags:
  - "type/page"
  - "section/network"
...
When all is set up correctly then you can press the Update Thumbnail button. This will start the transfer of the thumbnails to the console. This might take a while and there will be a progress bar in the "CITP Command" cell. It can also be done using the command line. Please read more about it in the [UpdateThumbnails](../../Keywords/UpdateThumbnails.md) command.
...
← [Streaming CITP video](Streaming%20CITP%20video.md)
