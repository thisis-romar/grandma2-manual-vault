...
DHCP is enabled as a default when you do a full install. It can also be enabled on Consoles, NPU, and DMX Nodes from the Setup->Network->MA Network Configuration. Read more about this in the [[Pages/Networking/Adding devices to the session|Adding devices to your session topic]].
