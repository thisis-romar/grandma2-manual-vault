...
prev_page: "[Pages/Networking/PosiStageNet (PSN)](PosiStageNet%20%28PSN%29.md)"
depth: 2
tags:
  - "type/page"
  - "section/network"
...
> [!source]- Source
> [MA Lighting Help – FTP connection to console and NPU](https://help.malighting.com/grandMA2/en/help/key_network_ftp.html)
...
![](../../img/img_ftp_main-folder_v3-3.PNG)
...
![](../../img/img_ftp_gma-folder_v3-3.PNG)
...
On the consoles it is also possible to get these crash logs using the [CrashLogCopy](../../Keywords/CrashLogCopy%20keyword.md) keyword. This is not possible on the NPUs.
...
← [PosiStageNet (PSN)](PosiStageNet%20%28PSN%29.md)
