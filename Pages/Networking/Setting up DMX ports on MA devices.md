...
next_page: "[Pages/Networking/Network DMX protocols](Network%20DMX%20protocols.md)"
depth: 3
tags:
  - "type/page"
  - "section/network"
...
> [!source]- Source
> [MA Lighting Help – Setting up DMX ports on MA devices](https://help.malighting.com/grandMA2/en/help/key_network_dmx_configure_ports.html)
...
The MA Network Configuration is separated into different sections. One for each type of MA device. Read more about these section and adding devices in the [Adding devices to your session](Adding%20devices%20to%20the%20session.md) topic.
...
![](../../img/menu_ma-network-configuration_dmx-ports_v3-2.png)
...
*   **In** - The DMX port is functioning as an DMX input. It will merge values into the universe number typed in the green universe field - If "DMX In Merge" is activated in the Setup->Show->Patch only->[DMX List](../Patching/DMX%20and%20Parameter%20lists.md).
...
Read more about configuring the MA Nodes in the [Control the MA Node section](../../Sections/Control%20MA%20xPort%20Nodes.md).
...
Please read the [Export and Import topics](../../Sections/Export%20and%20Import.md) for more information about this.

[Network DMX protocols](Network%20DMX%20protocols.md) →
