...
cssclasses:
  - "gma2-page"
title_str: "Protecting the session and station"
...
prev_page: "[Pages/Networking/How to create a session](How%20to%20create%20a%20session.md)"
next_page: "[Pages/Networking/Adding devices to the session](Adding%20devices%20to%20the%20session.md)"
depth: 3
tags:
  - "type/page"
  - "section/network"
...
> [!source]- Source
> [MA Lighting Help – Protecting the session and station](https://help.malighting.com/grandMA2/en/help/key_network_session_protect.html)
...
← [How to create a session](How%20to%20create%20a%20session.md) | [Adding devices to the session](Adding%20devices%20to%20the%20session.md) →
