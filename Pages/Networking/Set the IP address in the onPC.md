...
prev_page: "[Pages/Networking/Set the IP address in the console](Set%20the%20IP%20address%20in%20the%20console.md)"
next_page: "[Pages/Networking/Using DHCP in MA devices](Using%20DHCP%20in%20MA%20devices.md)"
depth: 2
tags:
  - "type/page"
  - "section/network"
...
When you have set the IP address in the computer, then you can use the [SetIP command](../../Keywords/SetIP.md) to set the IP address. It is important that you write the same IP address as the one set in the computer.

Follow the link to read more about using the [SetIP command](../../Keywords/SetIP.md).
...
← [Set the IP address in the console](Set%20the%20IP%20address%20in%20the%20console.md) | [Using DHCP in MA devices](Using%20DHCP%20in%20MA%20devices.md) →
