...
prev_page: "[Pages/Workspace/Calculator](Calculator.md)"
next_page: "[Pages/Workspace/Oops and undo](Oops%20and%20undo.md)"
depth: 2
tags:
  - "type/page"
  - "section/ws"
...
> [!source]- Source
> [MA Lighting Help – Info](https://help.malighting.com/grandMA2/en/help/key_ws_info.html)
...
*   Tap on an empty space on one of the screens, tap Other, tap Info.  
    ...
    ![](../../img/window_info-empty_v3_2.png)
...
*   [Open the info window](<#Open info window>) and type the info in the info window (black area).
    
    ![](../../img/window_info-assigned_v3_2.png)
    
    _Assigned info in the info window_
    

The info is assigned to the object on the selected executor. The pool object has a **information icon** ![](../../img/icon_information_v3-2.png) in the upper right corner.

If the sheet style is selected for pool, the info is displayed in the info column.

**Hint:**  
You can also assign info by using the command line along with the object keyword and the parameter **info**. See as an example the [Preset keyword](../../Keywords/Preset.md).
...
1.  [Open the info window](<#Open info window>) and tap in the title bar the button Info.  
    The words **Select something** appears in the info window and the button in the title bar changes to Not Linked. The [Info keyword](../../Keywords/Info.md) is in the command line.
    
    ![](../../img/window_info-select-something_v3_2.png)
    
    _Select something to assign info in the info window_
    
2.  Tap in a pool at the pool object to assign the information.  
    The title bar in the information window displays the pool object label and the pool object number.
3.  Type the info in the info window (black area).
...
The info is assigned to the selected object. The pool object has a **information icon** ![](../../img/icon_information_v3-2.png) in the upper right corner.
...
1.  Open the pool of the stored pool object.
2.  To turn the pool window into a sheet style, tap at the **yellow ball** ![](../../img/icon_yellow-ball_3_2.png)  and then tap Sheet Style.
3.  Type the info in the **info column**.
    
    ![](../../img/window_macro-pool-sheet-style_v3_2.png)
...
*   [Open the info window](<#Open info window>) and swipe the button in the title bar to select Link Last Go.
...
*   [Open the info window](<#Open info window>) and swipe the button in the title bar to select Link Current Cue.
...
*   [Open the info window](<#Open info window>) and swipe the button in the title bar to select Link Next Cue.

The info window displays the info to the next cue of the selected executor.

← [Calculator](Calculator.md) | [Oops and undo](Oops%20and%20undo.md) →
