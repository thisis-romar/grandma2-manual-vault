...
prev_page: "[Pages/Macros/Edit a macro](Edit%20a%20macro.md)"
next_page: "[Pages/Macros/Assign a macro to a key](Assign%20a%20macro%20to%20a%20key.md)"
depth: 2
tags:
  - "type/page"
  - "section/macro"
...
> [!source]- Source
> [MA Lighting Help – Command line interaction](https://help.malighting.com/grandMA2/en/help/key_macro_cli.html)
...
You can turn on or off the CLI when you create or edit a macro - read more about this in the [Manually create a macro topic](Manually%20create%20a%20macro.md) and the [Edit a macro topic](Edit%20a%20macro.md).
...
Now you can assign this macro to an executor or view button and just press that whenever you want to use the layout command. Read more about assigning macros in the [Assign a macro to a key topic](Assign%20a%20macro%20to%20a%20key.md).

You can read more about the @ command in the [At @ topic](../../Keywords/At%20@%20Character.md).

← [Edit a macro](Edit%20a%20macro.md) | [Assign a macro to a key](Assign%20a%20macro%20to%20a%20key.md) →
