...
next_page: "[Pages/Macros/Create pop-ups in macros](Create%20pop-ups%20in%20macros.md)"
depth: 3
tags:
  - "type/page"
  - "section/macro"
...
> [!source]- Source
> [MA Lighting Help – Use variables in macros](https://help.malighting.com/grandMA2/en/help/key_macro_create_variables.html)
...
Variables are defined using the [SetVar keyword](../../Keywords/SetVar.md) and the [$ character](../../Keywords/Dollar%20$%20Character.md):
...
This is an example of using a variable in a cue list. See the [Example macros topic](Example%20macros.md) for more examples of using variables in macros.
...
Similar to the SetVar keyword is the [SetUserVar keyword](../../Keywords/SetUserVar.md).
...
There are two commands that allow you to do a little addition with variables: [AddVar](../../Keywords/AddVar.md) and [AddUserVar](../../Keywords/AddUserVar%20keyword.md).
...
For more practical examples please read the [Example macros topic](Example%20macros.md).

[Create pop-ups in macros](Create%20pop-ups%20in%20macros.md) →
