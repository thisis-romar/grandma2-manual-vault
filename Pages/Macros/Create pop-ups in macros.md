...
prev_page: "[Pages/Macros/Use variables in macros](Use%20variables%20in%20macros.md)"
next_page: "[Pages/Macros/Conditional expressions](Conditional%20expressions.md)"
depth: 3
tags:
  - "type/page"
  - "section/macro"
...
> [!source]- Source
> [MA Lighting Help – Create pop-ups in macros](https://help.malighting.com/grandMA2/en/help/key_macro_create_popup.html)
...
SetVar $my\_user=("What User do you want to login?")

2

SetVar $my\_password=("What is the password?")

3

Login $my\_user $my\_password
...
See more examples in the [Example macros topic](Example%20macros.md).

← [Use variables in macros](Use%20variables%20in%20macros.md) | [Conditional expressions](Conditional%20expressions.md) →
