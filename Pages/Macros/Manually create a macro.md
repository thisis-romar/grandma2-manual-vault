...
CLI is short for Command Line Interaction. CLI is activated when the text is yellow - it is active by default. CLI allows you to interact with the pool object. This means that the command line will react to you tapping the macro in the pool. Read more details about CLI and Macros in the [Command line interaction topic](key_macro_cli.html).  

**Timing:**

The Timing button allows you to turn on the timing defined in each macro line or to just run it as fast as possible. Read more about macro timing in the [Macro timing subtopic](key_macro_create_timing.html).
...
This button is used to load one of the predefined (factory-made) macros. For more about this please read the [Import predefined macros topic](key_ei_import_predefined.html).
...
*   [Use variables](key_macro_create_variables.html)
*   [Create pop-ups](key_macro_create_popup.html)
*   [Conditional expressions](key_macro_create_condition.html)
*   [Macro timing](key_macro_create_timing.html)
