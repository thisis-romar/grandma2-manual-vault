...
next_page: "[Pages/Macros/Manually create a macro](Manually%20create%20a%20macro.md)"
depth: 2
tags:
  - "type/page"
  - "section/macro"
...
> [!source]- Source
> [MA Lighting Help – What are macros](https://help.malighting.com/grandMA2/en/help/key_macro_what_are.html)
...
If you do not know about pools, then please read the [Pools in General topic](../../Sections/Pools.md). 

## Macro Pool

The Macro pool could look like this:

![](../../img/window_macro-pool_v3-3.png)
...
![](../../img/window_macro-pool_sheet-style_v3-3.png)

_Macro Pool - sheet style_

Read the [Manually create a macro topic](Manually%20create%20a%20macro.md) to learn more about creating macros.
...
Macros can also be assigned to Executors, X Keys, or View buttons. To learn more please read the [Assign a macro to a button topic](Assign%20a%20macro%20to%20a%20key.md).
...
Please read the [Manually create a macro topic](Manually%20create%20a%20macro.md) and the subtopics for more about advanced macros.

If you need even more advanced access to the system behind the grandMA2 then you can use the grandMA2 Plugins. They allow for LUA scripts to be used to interact with the software. This is for the very advanced users. Read more about this in the [Plugins section](../../Sections/Plugins.md).
...
Read more about these options in the [Macro timing topic](Macro%20timing.md).

## Import and Export

Macros can also be imported and exported. You can import macros stored on a USB stick or from the predefined macros in the software. Read more in the [Export and Import section](../../Sections/Export%20and%20Import.md) to learn more about how to export and import.
...
To learn macros, you need to learn the grandMA2 command line syntax. This is described in details in the [Command Syntax and Keywords section](../../Sections/Command%20Syntax%20and%20Keywords.md).
...
![](../../img/window_command-line-feedback_v3-3.png)
...
[Manually create a macro](Manually%20create%20a%20macro.md) →
