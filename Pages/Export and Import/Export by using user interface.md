...
prev_page: "[Pages/Export and Import/Export by using command line](Export%20by%20using%20command%20line.md)"
next_page: "[Pages/Export and Import/Import by using command line](Import%20by%20using%20command%20line.md)"
depth: 2
tags:
  - "type/page"
  - "section/ei"
summary: "There is a dedicated GUI for exporting Macros, Effects, Masks, MAtricks, Gobo Bitmaps, User Profiles and DMX Nodes."
---
...
← [Export by using command line](Export%20by%20using%20command%20line.md) | [Import by using command line](Import%20by%20using%20command%20line.md) →
