...
prev_page: "[Pages/Single and Multi User Systems/What is the difference between a single-user and a multi-user system](What%20is%20the%20difference%20between%20a%20single-user%20and%20a%20multi-user%20system.md)"
next_page: "[Pages/Single and Multi User Systems/User specific settings](User%20specific%20settings.md)"
depth: 2
tags:
  - "type/page"
  - "section/single"
summary: "The user system is divided into two different parts - The User and the User Profile."
---

# Create user profiles and users

> [!source]- Source
> [MA Lighting Help – Create user profiles and users](https://help.malighting.com/grandMA2/en/help/key_single_multi_systems_create.html)
...
![](../../img/menu_user-profiles_v3-3.png)
...
← [What is the difference between a single-user and a multi-user system](What%20is%20the%20difference%20between%20a%20single-user%20and%20a%20multi-user%20system.md) | [User specific settings](User%20specific%20settings.md) →
