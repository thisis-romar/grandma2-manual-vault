...
cssclasses:
  - "gma2-page"
title_str: "User specific settings"
...
section_ref: "[Sections/Single and Multi User Systems](../../Sections/Single%20and%20Multi%20User%20Systems.md)"
prev_page: "[Pages/Single and Multi User Systems/Create user profiles and users](Create%20user%20profiles%20and%20users.md)"
next_page: "[Pages/Single and Multi User Systems/Login on a station](Login%20on%20a%20station.md)"
depth: 2
tags:
  - "type/page"
  - "section/single"
...
> [!source]- Source
> [MA Lighting Help – User specific settings](https://help.malighting.com/grandMA2/en/help/key_single_multi_systems_user_settings.html)
...
[Follow this link to read more about the Sequences.](../../Sections/Cues%20and%20Sequences.md)

### Preset Defaults

The Preset defaults contain four different settings. They are not described here, please read the [Presets](../../Sections/Presets.md) topics instead.

### Layout Defaults

Tapping the Layout Defaults will open the settings for the Layout View on the entire screen.

[Follow this link to read more about the Layouts.](../../Sections/Layouts.md)
...
Please read the [Cues and Sequences](../../Sections/Cues%20and%20Sequences.md) and [Presets](../../Sections/Presets.md) topics instead.
...
*   **Speed Mode** - Selects the speed mode in Effects, Bitmap Effects and Speed Groups. Tapping it opens the **Select Speed Mode** pop-up. Here the options are:  
    ...
    **Sec** (Seconds)
    ...
    ![Figure 1: Select Speed Mode pop-up.](../../img/popup_select-speed-mode_v3-2.png)
    
    _Select Speed Mode pop-up_
...
*   **Trackball Function** - Opens the **Select Trackball Function** pop-up. Here you can select the mode sequence for your trackball when you press the Mouse key. The trackball can have four different modes:  
    ...
    **Wheel** - emulates the level wheel
    
    ![](../../img/popup_select-trackball-function_v3-2.png)
    
    _Select Trackball Function pop-up_
    
      
     
*   **Trackball Resolution** - Opens the **Select Trackball Resolution** pop-up. This is used to select the default resolution of the trackball. This can also be change on the fly by pressing the ![encoder](../../img/encoder_1.png) (encoder) key and holding it, then selecting one of the resolutions in the pop-up - more about the [Encoder key](../../Keys/Key.md) following the link.There are three different resolutions:  
    **Fine** (0.1% of the range)  
    **Normal** (1% of the range)  
    **Coarse** (5% of the range)
    
    ![](../../img/popup_select-trackball-resolution_v3-2.png)
    
    _Select Trackball Resolution pop-up_
...
*   **Trackball Rotation** - This is used to rotate the orientation of the trackball in the pan/tilt mode. It opens a **Trackball Rotation** pop-up:
    ...
    ![](../../img/popup_trackball-rotation_v3-2.png)
    
    _Trackball Rotation pop-up_
...
*   **Dimmer Wheel Mode** - Tapping this opens the **Select Dimmer Wheel Mode** pop-up. This is used to select the wheel mode of the level wheel. There are four options:  
    ...
    **Prop. -** (Proportional negative) - When using the level wheel to turn the values up the individual difference in value will decrease. Turning up to 100% will make all channels reach 100% at the same time.
    ...
    ![](../../img/popup_select-dimmer-wheel-mode_v3-2.png)
    
    _Select Dimmer Wheel Mode pop-up_
...
*   **Dimmer Wheel Resolution** - This is used to select the default resolution of the Level Wheel. This can also be change on the fly by pressing the ![encoder](../../img/encoder_1.png) (Encoder) key and holding it, then selecting one of the resolutions in the pop-up - more about the [Encoder key](../../Keys/Key.md) following the link.There are three different resolutions:  
    ...
    **Coarse** (5% of the range)
    ...
    ![](../../img/popup_select-dimmer-wheel-resolution_v3-2.png)
    
    _Select Dimmer Wheel Resolution_
    
     
*   **Channel Page Width** - Opens the **Select Channel Page Width** pop-up. Here the width of the channel pages can be selected. The options are:  
    ...
    **Full Page** (30 faders) - This will not add more faders to your grandMA2 light or grandMA2 ultra-light, but it will spread it out as if it was a grandMA2 full-size.
    
    ![](../../img/popup_select-channel-page-width_v3-2.png)
    
    _Select Channel Page Width pop-up_
    ...
     
*   **Dynamic Channel Page Shows Only Selected** - When this is On then the console will only display the selected fixtures in "Dynamic Channel Pages" - read more about the Dynamic Channel Pages in the [Channel Pages topic](../Advanced%20Executor%20Functionality/Channel%20Pages.md).  
     
*   **At Normal Percent** - Here you can define what percent should be considered "[At Normal](../../Keywords/Normal.md)". This is used when the At key is pressed twice.  
     
*   **Single Digit Value** - All numeric value input below 10 will be a multiplication of 10; for example: channel 1 at 5 = channel 1 gets value 50.  
     
*   **Max. Program Time** - This is the maximum allowed Program time for the **Program Time Special Master**. Follow this link [Time Control](../Workspace/Time%20Control.md) to read more about the Program Time.  
     
*   **Max. Exec Time** - This is the maximum allowed Executor time for the **Executor Time Special Master**. Follow this link [Time Control](../Workspace/Time%20Control.md) to read more about the Executor Time.  
     
*   **Special Fader Buttons** - Here you can Enable or Disable the extra buttons above the 100mm faders. Follow this link [Master Section](../Workspace/Master%20Section.md) to read more about this area.  
     
...
*   **EncoderLink** - The encoder link is used when working in the Fade, Delay and Effect layers. It has several options:  
    ...
    **Filter Active** - Same as above, but limited to parameters that are already active in programmer.
    
    ![](../../img/popup_select-encoder-link_v3-2.png)
    
    _Select Encoder Link pop-up_
    
    *   **Programmer Colors** - This setting allows to change between two different set of visual color feedback regarding the programmer. The two options are **Standard** and **High Contrast**. Read about the in the [System Colors topic](../Workspace/System%20Colors.md).

← [Create user profiles and users](Create%20user%20profiles%20and%20users.md) | [Login on a station](Login%20on%20a%20station.md) →

Part of [Single and Multi User Systems](../../Sections/Single%20and%20Multi%20User%20Systems.md) · [000 Map of Content](../../000%20Map%20of%20Content.md)
