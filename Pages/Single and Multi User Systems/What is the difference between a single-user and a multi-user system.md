...
cssclasses:
  - "gma2-page"
title_str: "What is the difference between a single-user and a multi-user system"
...
next_page: "[Pages/Single and Multi User Systems/Create user profiles and users](Create%20user%20profiles%20and%20users.md)"
depth: 2
tags:
  - "type/page"
  - "section/single"
...
> [!source]- Source
> [MA Lighting Help – What is the difference between a single-user and a multi-user system](https://help.malighting.com/grandMA2/en/help/key_single_multi_systems_difference.html)
...
[Create user profiles and users](Create%20user%20profiles%20and%20users.md) →
