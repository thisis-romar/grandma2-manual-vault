...
prev_page: "[Pages/Agenda/What is agenda](What%20is%20agenda.md)"
depth: 2
tags:
  - "type/page"
  - "section/agenda"
...
> [!source]- Source
> [MA Lighting Help – Create an appointment in the agenda](https://help.malighting.com/grandMA2/en/help/key_agenda_create_appointment.html)

Version 3.9

# Create an appointment in the agenda

To create an appointment in the agenda, tap on a date in the Agenda window. To get to the **Agenda window**, see the [What is agenda](What%20is%20agenda.md) topic.

The Agenda window will now change, and it could look like this:

![](../../img/window_agenda_appointment_v3_3.png)

_Agenda appointment window_

In the left side of the window, 4 new buttons become visible:
...
For more information about time and place, see the [Date & time](../Console%20Settings/Date%20&%20Time.md) topic.
...
This field will manage how often the appointment will be repeated. Tap on the field and a pop-up will appear with different options:

![](../../img/popup_agenda_repeat_v3_3.png)

_Repeat options_

Select the interval you need.

CMD

This is the command that will be executed for this appointment.

For more information about commands and keywords, see the [Command Syntax and Keywords](../../Sections/Command%20Syntax%20and%20Keywords.md) topic.
...
![](../../img/img_agenda_encoder_v3_3.png)
...
← [What is agenda](What%20is%20agenda.md)
