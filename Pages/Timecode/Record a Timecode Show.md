...
A simple way to trigger cues using a  timecode signal is the **Timecode** trigger in the [[Pages/Command Syntax and Keywords/Looking at the Cue Sequence|Sequence Executor Sheet]]. Read about the triggers in the [[Pages/Command Syntax and Keywords/Playing back Cues|Playing Back Cues topic]].

Each sequence can be assigned a timecode slot - see how in the [[Pages/Command Syntax and Keywords/What are cues and sequences|What are Cues and Sequences topic]].
...
Press ![ma](../../img/ma_1.png)+Store to get the [[Keywords/Record|Record keyword]], then press any of the keys associated with the executor where the sequence is assigned. It can also be typed as a command: Record Executor \[number\]
