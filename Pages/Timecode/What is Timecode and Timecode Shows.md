...
cssclasses:
  - "gma2-page"
title_str: "What is Timecode and Timecode Shows"
...
next_page: "[Pages/Timecode/Record a Timecode Show](Record%20a%20Timecode%20Show.md)"
depth: 2
tags:
  - "type/page"
  - "section/timecode"
...
> [!source]- Source
> [MA Lighting Help – What is Timecode and Timecode Shows](https://help.malighting.com/grandMA2/en/help/key_timecode_what_is.html)
...
![](../../img/window_timecode-slots-pool_v3-3.png)
...
![](../../img/window_timecode-slots-pool_sheet-style_v3-3.png)

_Timecode Slots pool - sheet style_

Now it is possible to a see a lot that actually can be changed for each of the 8 timecode slots. They are all explained in the [Playing Back a Timecode Show topic](Playing%20Back%20a%20Timecode%20Show.md).
...
![](../../img/window_clock_timecode-slot-1_v3-3.png)
...
![](../../img/window_timecode-pool_v3-3.png)

_Timecode pool - pool style_

It looks different than most pools, since the two first pool objects are replaced with a time information object. This area displays the time from the slots assigned to the inputs on your station - read about the timecode slots above. It is only for information, It cannot do anything. The time format and colors are discussed more in the [Playing Back a Timecode Show topic](Playing%20Back%20a%20Timecode%20Show.md).

The pool behaves otherwise like most other pools - please read the [Pools in General section](../../Sections/Pools.md).

The timecode pool could look like this if changed to the "Sheet Style":

![](../../img/window_timecode-pool_sheet-style_v3-3.png)
...
![](../../img/window_timecode-view_v3-3.png)
...
The timecode view is very similar to the timecode editor, except the editor has more options. Please read the [Edit a Timecode Show topic](Edit%20a%20Timecode%20Show.md) for more information about the editor and thereby also this viewer.

[Record a Timecode Show](Record%20a%20Timecode%20Show.md) →
