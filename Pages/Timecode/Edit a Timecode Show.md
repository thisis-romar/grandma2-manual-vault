...
cssclasses:
  - "gma2-page"
title_str: "Edit a Timecode Show"
...
prev_page: "[Pages/Timecode/Record a Timecode Show](Record%20a%20Timecode%20Show.md)"
next_page: "[Pages/Timecode/Playing Back a Timecode Show](Playing%20Back%20a%20Timecode%20Show.md)"
depth: 2
tags:
  - "type/page"
  - "section/timecode"
summary: "Editing a timecode show opens the Timecode Editor pop-up."
---

# Edit a Timecode Show

> [!source]- Source
> [MA Lighting Help – Edit a Timecode Show](https://help.malighting.com/grandMA2/en/help/key_timecode_editor.html)
...
![](../../img/popup_edit-timecode_graphic-style_v3-3.png)
...
![](../../img/popup_edit-timecode_text-style_v3-3.png)
...
*   **Add Multiple**:  
    ...
    ![](../../img/popup_create-multiple-events_v3-3.png)
...
*   **Create Selection**:  
    ...
    ![](../../img/popup_create-selection_v3-3.png)
...
*   **Play**:  
    Plays the timecode show. Read more in the [Playing Back a Timecode Show topic](Playing%20Back%20a%20Timecode%20Show.md).

### Track Functions

The Track Functions are opened by tapping the Track Functions button. It could look like this:

![](../../img/popup_track-functions_v3-3.png)
...
*   **Change Executor/Fader**:  
    ...
    ![](../../img/popup_select-executor-for-existing-track_v3-3.png)
...
*   **Add New Sub Track**:  
    ...
    ![](../../img/popup_select-new-sub-track_v3-3.png)
...
![](../../img/popup_edit-timecode_graphic-style_detail_v3-3.png)
...
![](../../img/popup_event-command_v3-3.png)
...
![](../../img/popup_edit-timecode_text-style_detail_v3-3.png)
...
![](../../img/popup_timecode-options_v3-3.png)
...
*   **Slot:**  
    ...
    ![](../../img/popup_select-timecode-slot_v3-3.png)
...
*   **Time unit**:  
    ...
    ![](../../img/popup_select-time-unit_v3-3.png)
...
← [Record a Timecode Show](Record%20a%20Timecode%20Show.md) | [Playing Back a Timecode Show](Playing%20Back%20a%20Timecode%20Show.md) →
