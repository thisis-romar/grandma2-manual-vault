...
prev_page: "[Pages/Timecode/Edit a Timecode Show](Edit%20a%20Timecode%20Show.md)"
next_page: "[Pages/Timecode/Organize The Show with Multiple Timecode Shows](Organize%20The%20Show%20with%20Multiple%20Timecode%20Shows.md)"
depth: 2
tags:
  - "type/page"
  - "section/timecode"
...
*   **Edit Timecode Show**:  
    Tapping this button will open the timecode editor - please read the [Edit a Timecode Show topic](Edit%20a%20Timecode%20Show.md) for details.
*   **Jump to Start**:  
...
*   **Record**:  
    Tapping this will set the timecode show in **Record mode** - read more about recording a timecode show in the [Record a Timecode Show topic](Record%20a%20Timecode%20Show.md).
...
*   **Track**:  
    This is used to select a track - read more in the [Edit a Timecode Show topic](Edit%20a%20Timecode%20Show.md).
*   **Event**:  
...
A [Go](../../Keywords/Go.md) command will set the timecode show in play mode.
...
It can also be paused to a specific time by using the command above but with [Pause](../../Keywords/Pause.md) instead of Go.

[<<<](../../Keywords/---%20%5BGoFastBack%5D%20keyword.md) will jump to the time 0 (zero).

\[Channel\]> <<< Timecode 4

[\>>>](../../Keywords/---%20%5BGoFastForward%5D%20keyword.md) will jump to the end time (length in the options).

[Off](../../Keywords/Off.md) can be used to stop a timecode show.

## Timecode Generator

Each [timecode slot](What%20is%20Timecode%20and%20Timecode%20Shows.md) can generate a timecode signal for the session. This signal will not be output by the LTC or MIDI ports, but it will be distributed in a session.
...
To play or generate timecode slot 1 use the [Go](../../Keywords/Go.md) command:

\[Channel\]> Go TimecodeSlot 1

Use [Off](../../Keywords/Off.md) to stop the generator. [Pause](../../Keywords/Pause.md) will pause the generator.

← [Edit a Timecode Show](Edit%20a%20Timecode%20Show.md) | [Organize The Show with Multiple Timecode Shows](Organize%20The%20Show%20with%20Multiple%20Timecode%20Shows.md) →
