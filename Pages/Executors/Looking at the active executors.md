...
prev_page: "[Pages/Executors/Assign a function](Assign%20a%20function.md)"
next_page: "[Pages/Executors/Common executor options](Common%20executor%20options.md)"
depth: 2
tags:
  - "type/page"
  - "section/exec"
...
> [!source]- Source
> [MA Lighting Help – Looking at the active executors](https://help.malighting.com/grandMA2/en/help/key_exec_running_playbacks.html)
...
A window similar to the Off Menu is called **Running Playbacks**. It can be made like any other window - using the [Create Basic Windows pop-up](../../Sections/Windows.md). This window can be found in the **Playbacks** tab. It could look like this:
...
← [Assign a function](Assign%20a%20function.md) | [Common executor options](Common%20executor%20options.md) →
