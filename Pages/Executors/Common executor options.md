...
prev_page: "[Pages/Executors/Looking at the active executors](Looking%20at%20the%20active%20executors.md)"
depth: 2
tags:
  - "type/page"
  - "section/exec"
...
The executors most common options, and their associated options, are explained in this topic. The rest are explained in the [Executor Options topic](../Advanced%20Executor%20Functionality/Executor%20Options.md).
...
The priorities are one of the common options to change. The description of the priorities are found in the [Playing Back Cues topic](../Command%20Syntax%20and%20Keywords/Playing%20back%20Cues.md).

## Tracking

Explanations about tracking and how to turn it On or Off is found in the [What is Tracking topic](../Command%20Syntax%20and%20Keywords/What%20is%20Tracking.md). Here are also the explanations about **Release Firststep** and **Wrap Around**.
...
← [Looking at the active executors](Looking%20at%20the%20active%20executors.md)
