...
prev_page: "[Pages/Executors/Executors on the screens](Executors%20on%20the%20screens.md)"
next_page: "[Pages/Executors/Looking at the active executors](Looking%20at%20the%20active%20executors.md)"
depth: 2
tags:
  - "type/page"
  - "section/exec"
...
> [!source]- Source
> [MA Lighting Help – Assign a function](https://help.malighting.com/grandMA2/en/help/key_exec_assign.html)
...
2.  Tap the top part of the [Mini Executor Bar](../Workspace/Mini%20executor%20bar.md).

The assign menu can look like this:

![](../../img/menu_assign_function_empty_v3-3.png)
...
![](../../img/menu_assign_function_sequence_v3-3.png)
...
![](../../img/menu_assign_function_width-1_v3-3.png)
...
![](../../img/popup_select-function-key_v3-3.png)
...
*   **Goto**:  
    ...
    ![](../../img/popup_select-cue-for-goto_v3-3.png)
...
*   **Kill**:  
    This is the same as a "Go" but it also turns of all other executors (except those that has "Kill protect" turned on - see [Executor Options topic](../Advanced%20Executor%20Functionality/Executor%20Options.md)).
*   **Learn**:  
...
*   **Swop**:  
    When this is pressed, all other fixtures will fade out the dimmer (except those that has "Swop protect" turned on - see [Executor Options topic](../Advanced%20Executor%20Functionality/Executor%20Options.md)). They return when it is released.
*   **SwopOn**:  
...
These main functions are keywords - they can be found in the [All keywords topics](../Command%20Syntax%20and%20Keywords/All%20keywords.md). Here are detailed descriptions of all keywords.
...
![](../../img/popup_select-function-fader_v3-3.png)
...
*   **CrossfadeA**:  
    Is the first of a two fader manual crossfade between two cues. Works along with CrossfadeB. The crossfade function can be changed in the [Executor options](../Advanced%20Executor%20Functionality/Executor%20Options.md).
*   **CrossfadeB**:  
    Is the second of a two fader manual crossfade between two cues. Works along with CrossfadeA. The crossfade function can be changed in the [Executor options](../Advanced%20Executor%20Functionality/Executor%20Options.md).
*   **Rate**:  
    Divides the fade and delay time in a sequence by the value of the fader. If **Link Effect to Rate** is on, it is also valid for effect speed stored in cues - see [Executor options topic](../Advanced%20Executor%20Functionality/Executor%20Options.md).
*   **StepFade**:  
...
The above functions are described in more details in each of their keyword topics. They can be found under [All Keywords](../Command%20Syntax%20and%20Keywords/All%20keywords.md).
...
![](../../img/menu_assign_function_width-5_v3-3.png)
...
← [Executors on the screens](Executors%20on%20the%20screens.md) | [Looking at the active executors](Looking%20at%20the%20active%20executors.md) →
