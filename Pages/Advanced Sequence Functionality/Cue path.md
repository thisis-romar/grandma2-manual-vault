...
prev_page: "[Pages/Advanced Sequence Functionality/Looping cues](Looping%20cues.md)"
depth: 2
tags:
  - "type/page"
  - "section/adv"
...
Each cue and cue part can have a path assigned. It is done in the [Sequence Executor Sheet](../Command%20Syntax%20and%20Keywords/Looking%20at%20the%20Cue%20Sequence.md), where there is a **Path** column.
...
Custom paths can be made in the [DMX Profiles Graph Editor](../../Sections/DMX%20Profiles.md). If there are customs paths, then they will appear at the bottom of the **Select Fade Path pop-up**.
...
← [Looping cues](Looping%20cues.md)
