...
prev_page: "[Pages/Advanced Sequence Functionality/Using Cue Modes](Using%20Cue%20Modes.md)"
next_page: "[Pages/Advanced Sequence Functionality/Sequence info window](Sequence%20info%20window.md)"
depth: 2
tags:
  - "type/page"
  - "section/adv"
summary: "Cue Zero is an automatically created cue containing a link to default values of attributes."
---

# Cue Zero

> [!source]- Source
> [MA Lighting Help – Cue Zero](https://help.malighting.com/grandMA2/en/help/key_adv_seq_cue_zero.html)
...
Cue Zero is only available in sequences where [Tracking](../Command%20Syntax%20and%20Keywords/What%20is%20Tracking.md) is activated and there needs to be more than one cue.
...
![](../../img/window_sequence-executor-sheet_cue-zero-on_v3-3.png)
...
← [Using Cue Modes](Using%20Cue%20Modes.md) | [Sequence info window](Sequence%20info%20window.md) →
