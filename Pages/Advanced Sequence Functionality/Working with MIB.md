...
prev_page: "[Pages/Advanced Sequence Functionality/Using different view sets in the sheets](Using%20different%20view%20sets%20in%20the%20sheets.md)"
next_page: "[Pages/Advanced Sequence Functionality/Using Cue Modes](Using%20Cue%20Modes.md)"
depth: 2
tags:
  - "type/page"
  - "section/adv"
summary: "This topic is about some of the details concerning MIB (Move In Black)."
---

# Working with MIB

> [!source]- Source
> [MA Lighting Help – Working with MIB](https://help.malighting.com/grandMA2/en/help/key_adv_seq_mib.html)

Version 3.9

# Working with MIB

This topic is about some of the details concerning MIB (Move In Black). The [What is MIB topic](../Command%20Syntax%20and%20Keywords/What%20is%20MIB.md) might be a good place to start if MIB is new to you.

## MIB values

The MIB value is assigned in the MIB column in the [Sequence Executor Sheet](../Command%20Syntax%20and%20Keywords/Looking%20at%20the%20Cue%20Sequence.md).
...
These issues may be minimized by not prepositioning too early, or by activating "MIB Never" in the Executor options, if you are to make major changes to your cues - Executor Options are described in the [Executor Options topic](../Advanced%20Executor%20Functionality/Executor%20Options.md).

← [Using different view sets in the sheets](Using%20different%20view%20sets%20in%20the%20sheets.md) | [Using Cue Modes](Using%20Cue%20Modes.md) →
