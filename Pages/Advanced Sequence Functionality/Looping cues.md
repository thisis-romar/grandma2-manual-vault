...
prev_page: "[Pages/Advanced Sequence Functionality/Sequence info window](Sequence%20info%20window.md)"
next_page: "[Pages/Advanced Sequence Functionality/Cue path](Cue%20path.md)"
depth: 2
tags:
  - "type/page"
  - "section/adv"
...
> [!source]- Source
> [MA Lighting Help – Looping cues](https://help.malighting.com/grandMA2/en/help/key_adv_seq_loop.html)
...
In the [Sequence Executor Sheet](../Command%20Syntax%20and%20Keywords/Looking%20at%20the%20Cue%20Sequence.md) there are three columns that control looping. They are: **Loop**, **Ltime**, and **Lcount**.
...
![](../../img/popup_select-loop-destination_v3-3.png)
...
![](../../img/window_sequence-executor-sheet_loop-active_v3-3.PNG)
...
The Executors have an options called **Loop BreakingGo**. It can be found in the Options page of the Assign Menu - read more about it in the [Executor Options topic](../Advanced%20Executor%20Functionality/Executor%20Options.md).
...
← [Sequence info window](Sequence%20info%20window.md) | [Cue path](Cue%20path.md) →
