...
next_page: "[Pages/Advanced Fixture Types/Instance Manager](Instance%20Manager.md)"
depth: 3
tags:
  - "type/page"
  - "section/adv"
...
> [!source]- Source
> [MA Lighting Help – Module Manager](https://help.malighting.com/grandMA2/en/help/key_adv_fixture_anatomy_modules.html)

Version 3.9

# Module Manager

If you have arrived at this topic from a link without reading the previous topic, then please read [Anatomy of a Fixture Type](Anatomy%20of%20a%20Fixture%20Type.md) first.
...
![](../../img/menu_fixture-editor_module-manager_v3-3.png)
...
*   **MIB Delay**:  
    The module can have a custom MIB delay value. The "Default" value will use the **MIB Delay** time defined in the **Playback & MIB Timing** settings in the **Setup**. Read more about MIB in the [Working with MIB topic](../Advanced%20Sequence%20Functionality/Working%20with%20MIB.md).
*   **Class**:  
...
*   **Beam**:  
    ...
    ![](../../img/popup_select-beam_v3-3.png)
...
![](../../img/popup_select-class_v3-3.png)
...
*   **Grandma Bitmap Layer**:  
    This class is used by the **Bitmap** fixture from MA Lighting. This virtual fixture can be used to apply values to other fixtures - Read more in the [Bitmap Fixture section](../../Sections/Bitmap%20Fixture.md). There is no 3D model associated with the class.
*   **Marker**:  
