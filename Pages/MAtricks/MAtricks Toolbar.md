...
next_page: "[Pages/MAtricks/MAtricks Pool](MAtricks%20Pool.md)"
depth: 2
tags:
  - "type/page"
  - "section/matricks"
...
2.  Open the encoder bar. For more information see [Encoder toolbar](../Workspace/Encoder%20Toolbar.md).  
    For information on how to open the encoder bar via the **Create Basic Window** see [Encoder bar](../Workspace/Encoder%20Bar.md). 
3.  To enable MAtricks, press the Set key.  
    For more information on the Set key see [Set](../../Keys/Set%20Key.md).   
    \-or-  
    \-Tap an object in the MAtricks pool.  
    For more information see [MAtricks pool](MAtricks%20Pool.md).  
    \-or-  
...
6.  Store the settings you have just made in the MAtricks toolbar:  
    ...
    For more information on the MAtricks pool see [MAtricks pool](MAtricks%20Pool.md). 
...
**Hint:**  
It is also possible to reset the MAtricks using the [ClearAll](../../Keywords/ClearAll%20keyword.md) or the [MAtricksReset](../../Keywords/MAtricksReset.md) keyword. 

**Circular Copy:**

Copies values in a circular manner in the MAtricks. For more information see [CircularCopy](../../Keywords/CircularCopy%20keyword.md) keyword. 
...
Applies the function Shuffle to the selection in the MAtricks. For more information see [ShuffleSelection](../../Keywords/ShuffleSelection.md) keyword. 

*   To apply this function, tap Shuffle Selection. 

**Hint:**  
Settings stored in the MAtricks pool can be assigned to the User keys. For more information see [User 1](../../Keys/User%201%20Key.md) key and [User 2](../../Keys/User%202%20Key.md) key.

[MAtricks Pool](MAtricks%20Pool.md) →
