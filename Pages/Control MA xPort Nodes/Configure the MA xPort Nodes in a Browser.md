...
section_ref: "[Sections/Control MA xPort Nodes](../../Sections/Control%20MA%20xPort%20Nodes.md)"
prev_page: "[Pages/Control MA xPort Nodes/Configure the MA xPort Nodes in the Console](Configure%20the%20MA%20xPort%20Nodes%20in%20the%20Console.md)"
next_page: "[Pages/Control MA xPort Nodes/Configure the MA xPort Nodes as Splitters or Mergers](Configure%20the%20MA%20xPort%20Nodes%20as%20Splitters%20or%20Mergers.md)"
depth: 2
tags:
  - "type/page"
  - "section/control"
...
> [!source]- Source
> [MA Lighting Help – Configure the MA xPort Nodes in a Browser](https://help.malighting.com/grandMA2/en/help/key_control_ma_xport_node_configure_in_browser.html)
...
**Important:**  
This topic treats subject areas that are important for the configuration of nodes in a browser. General settings are treated in the topics [Adding devices to your session](../Networking/Adding%20devices%20to%20the%20session.md)​ and [Configure the DMX ports on MA devices](../Networking/Setting%20up%20DMX%20ports%20on%20MA%20devices.md).  
...
![](../../img/img_configure-nodes-in-browser_status-window_v3-3.png)
...
![](../../img/img_login-form_configure-nodes-in-browser_v3-3.png)
...
![](../../img/img_confirmation-window_configure-nodes-in-browser_v3-3.png)
...
![](../../img/img_node-configuration_configure-nodes-in-browser_v3-3.png)
...
10.  Adjust the settings:  
     ...
     For more information on DHCP see [Using DHCP in MA devices](../Networking/Using%20DHCP%20in%20MA%20devices.md).
11.   Adjust the ports in **XLR A**, **XLR B**, **XLR C**, and **XLR D**:  
     \-Select the port in the drop-down menu **Port Dir.**  
     For more information on the port and merge modes see [Configure the DMX ports on MA devices – Port Mode](../Networking/Setting%20up%20DMX%20ports%20on%20MA%20devices.md) and [Configure the DMX ports on MA devices – Merge Mode](../Networking/Setting%20up%20DMX%20ports%20on%20MA%20devices.md).  
...
← [Configure the MA xPort Nodes in the Console](Configure%20the%20MA%20xPort%20Nodes%20in%20the%20Console.md) | [Configure the MA xPort Nodes as Splitters or Mergers](Configure%20the%20MA%20xPort%20Nodes%20as%20Splitters%20or%20Mergers.md) →

Part of [Control MA xPort Nodes](../../Sections/Control%20MA%20xPort%20Nodes.md) · [000 Map of Content](../../000%20Map%20of%20Content.md)
