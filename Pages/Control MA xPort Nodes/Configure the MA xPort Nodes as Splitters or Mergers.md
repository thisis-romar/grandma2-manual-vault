...
prev_page: "[Pages/Control MA xPort Nodes/Configure the MA xPort Nodes in a Browser](Configure%20the%20MA%20xPort%20Nodes%20in%20a%20Browser.md)"
next_page: "[Pages/Control MA xPort Nodes/Delete the MA xPort Nodes in the Network Configuration](Delete%20the%20MA%20xPort%20Nodes%20in%20the%20Network%20Configuration.md)"
depth: 2
tags:
  - "type/page"
  - "section/control"
...
For information on how to configure nodes see [Configure nodes on the console](Configure%20the%20MA%20xPort%20Nodes%20in%20the%20Console.md) or [Configure nodes in a browser](Configure%20the%20MA%20xPort%20Nodes%20in%20a%20Browser.md). 
...
2.  Select the same universe for all ports in the pop-up **Configure DMX Port (MA-Net2 Mode)**.  
    For more information see [Configure nodes on the console](Configure%20the%20MA%20xPort%20Nodes%20in%20the%20Console.md).   
...
← [Configure the MA xPort Nodes in a Browser](Configure%20the%20MA%20xPort%20Nodes%20in%20a%20Browser.md) | [Delete the MA xPort Nodes in the Network Configuration](Delete%20the%20MA%20xPort%20Nodes%20in%20the%20Network%20Configuration.md) →
