...
next_page: "[Pages/Remote Control/MIDI Show Control (MSC)](MIDI%20Show%20Control%20%28MSC%29.md)"
depth: 2
tags:
  - "type/page"
  - "section/remote"
...
> [!source]- Source
> [MA Lighting Help – Remote Inputs](https://help.malighting.com/grandMA2/en/help/key_remote_control_input.html)
...
![](../../img/menu_remote-input-setup_analog_v3-3.png)
...
*   **Type**:  
    ...
    ![](../../img/popup_select-type_v3-3.png)
...
*   **Button** (relevant if Exec type is selected):  
    ...
    ![](../../img/popup_select-button_v3-3.png)
...
*   **Keycode** (relevant if Hardkey type is selected):  
    ...
    ![](../../img/popup_select-keycode_v3-3.png)
...
There are five buttons at the bottom of the menus. They can be tapped on the screen or maybe by using the X-Keys if the menu is on screen 1 (depending on "Xkeys" setting the [User settings](../Single%20and%20Multi%20User%20Systems/User%20specific%20settings.md)). This is a short description of the buttons:
...
Please read the [Connect Analog Remote Control topic](../First%20Steps/Connect%20Analog%20Remote%20Control.md) to learn more about the hardware part of the input.
...
[MIDI Show Control (MSC)](MIDI%20Show%20Control%20%28MSC%29.md) →
