...
prev_page: "[Pages/Remote Control/MIDI Show Control (MSC)](MIDI%20Show%20Control%20%28MSC%29.md)"
next_page: "[Pages/Remote Control/Telnet Remote](Telnet%20Remote.md)"
depth: 2
tags:
  - "type/page"
  - "section/remote"
...
At the bottom of almost every window there are three buttons with the [Set](../../Keys/Set%20Key.md), [Next](../../Keys/Next%20Key.md), and [Previous](../../Keys/Prev%20%28Previous%29%20Key.md) functions.
...
The fixture sheet displays the fixture information. For details about the **Fixture Sheet** please follow this link to the [Fixture Sheet topic](../Operate%20Fixtures/Fixture%20Sheet.md).
...
*   **Preset Value selector:**  
    Tapping this swipe button toggles through the following layers: **Value**, **Fade**, **Delay**, and **Output**. Swiping it opens a small pop-up that allows you to select the desired layer directly. Read about the layers in the [Layers in Sheets topics](../Operate%20Fixtures/Layer%20in%20Sheets.md).
...
The channel sheet displays the channel information. For details about the **Channel Sheet** please follow this link to the [Channel Sheet topic](../Operate%20Fixtures/Channel%20Sheet.md).
...
The group pool displays the groups. Read details about it in the [Groups topics](../../Sections/Groups.md).
...
This is the different preset pools. The windows works as the **Dynamic** pool in the console - read about it in the [Dynamic preset topic](../Presets/Preset%20Pool%20-Dynamic-.md). The preset types can be selected on the left hand side in both modes.
...
This is the macro pool - read about it in the [Macro topics](../../Sections/Macros.md). It displays all the macros. It is not possible to edit macros using the remote.
...
This is the world pool - learn about worlds in the [What are Worlds topic](../Worlds%20Filters%20and%20Masks/What%20are%20Worlds.md).
...
The Executor Sheet displays the [Sequence Executor Sheet](../Command%20Syntax%20and%20Keywords/Looking%20at%20the%20Cue%20Sequence.md).
...
This windows shows the virtual executors - read more about it in the [Executors on the Screens topic](../Executors/Executors%20on%20the%20screens.md).
...
← [MIDI Show Control (MSC)](MIDI%20Show%20Control%20%28MSC%29.md) | [Telnet Remote](Telnet%20Remote.md) →
