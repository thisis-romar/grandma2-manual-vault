...
prev_page: "[Pages/Groups/Create groups](Create%20groups.md)"
next_page: "[Pages/Groups/Using groups when programming](Using%20groups%20when%20programming.md)"
depth: 2
tags:
  - "type/page"
  - "section/groups"
summary: "You can auto create groups."
---

# Auto Create groups

> [!source]- Source
> [MA Lighting Help – Auto Create groups](https://help.malighting.com/grandMA2/en/help/key_groups_auto_create.html)
...
![](../../img/popup_auto-create_group_v3-2.png)
...
![](../../img/popup_auto-create-conflict_v3-2.png)
...
← [Create groups](Create%20groups.md) | [Using groups when programming](Using%20groups%20when%20programming.md) →
