...
cssclasses:
  - "gma2-page"
title_str: "Group Master on Executors"
...
prev_page: "[Pages/Groups/Change colors in group options for all in order and all out of order](Change%20colors%20in%20group%20options%20for%20all%20in%20order%20and%20all%20out%20of%20order.md)"
depth: 2
tags:
  - "type/page"
  - "section/groups"
...
> [!source]- Source
> [MA Lighting Help – Group Master on Executors](https://help.malighting.com/grandMA2/en/help/key_groups_master.html)
...
![](../../img/img_group-master_fixture-sheet-limited-fixtures_v3_2.png)
...
![](../../img/img_mini-executor-assign-menu_alternate_v3_2.png)

_Mini executor with open Assign Menu_

This will open the Assign Menu on one of the screens (default is screen 1) -  read more about the Assign Menu [here](../Executors/Assign%20a%20function.md).
...
![](../../img/popup_select-group-master-mode_v3-2.png)
...
![](../../img/img_mini-executor_group-master_positive_v3_2.png)
...
![](../../img/img_mini-executor_group-master_negative_v3_2.png)
...
![](../../img/img_mini-executor_group-master_additive_v3_2.png)
...
![](../../img/img_group-master_fixture-sheet-additive-value_v3_2.png)
...
![](../../img/img_mini-executor_group-master_located_v3_2.png)

_Located Group Master - Mini Executor_

To exit the locate function, you will need to execute the locate command without anything specified. Read more about the [locate command here](../../Keywords/Locate.md).
...
They are described in the [Masters Window topic](../Advanced%20Executor%20Functionality/Masters%20Window.md).

← [Change colors in group options for all in order and all out of order](Change%20colors%20in%20group%20options%20for%20all%20in%20order%20and%20all%20out%20of%20order.md)
