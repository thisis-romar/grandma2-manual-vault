...
prev_page: "[Pages/Command Syntax and Keywords/Playing back Cues](Playing%20back%20Cues.md)"
next_page: "[Pages/Command Syntax and Keywords/Update cues](Update%20cues.md)"
depth: 2
tags:
  - "type/page"
  - "section/cs"
...
> [!source]- Source
> [MA Lighting Help – Looking at the cue content](https://help.malighting.com/grandMA2/en/help/key_cs_cue_content.html)
...
Both sheets can be configured using the [Sheet Options](../Operate%20Fixtures/Sheet%20options.md) - access by tapping the yellow ball in the upper left corner.

## Sequence Content Sheet

The Sequence Content Sheets is used to see the fixtures and values stored in cues. It looks a lot like the [Fixture Sheet](../Operate%20Fixtures/Fixture%20Sheet.md), but it has a masking function that only displays what is stored in a cue. It is like a combined Sequence Tracking (read below) and Fixture Sheet.

It could look like this:

![](../../img/window_sequence-content-sheet_v3-3.png)
...
![](../../img/window_sequence-content-sheet_title-bar_v3-3.png)

_Sequence Content Sheet - Title Bar example_

There can be many [Title Buttons](../Operate%20Fixtures/Title%20buttons.md) in the Title Bar. These can be shown or hidden using the [Sheet Options](../Operate%20Fixtures/Sheet%20options.md) - they are access by tapping the yellow ball in the upper left corner.
...
This function is shared with the Tracking Sheet. Turning it On will make any changes you make to values as cue only changes - otherwise it will be made as tracking changes. If you are in doubt about what this means then please read the [What is Tracking topic](What%20is%20Tracking.md).
...
This toggle button is also a setting in the Sheet Options in the [Layer Mask tab](../Operate%20Fixtures/Layer%20mask.md).
...
*   **Not Linked:**  
    This will stop automatic linking and display the sequence assigned to the executor selected in the [Assign Executor tab](../Operate%20Fixtures/Assign%20executor.md) in the sheet options.
*   **Link Last Go:**  
    This will display the sequence assigned to the executor where you last performed a Go.

It is also in the sheets options. In the [Layer Mask tab](../Operate%20Fixtures/Layer%20mask.md) - here it is described in a little more details.
...
![](../../img/window_sequence-tracking-sheet_v3-3.png)
...
This function is also accessible in the [Layer Mask tab](../Operate%20Fixtures/Layer%20mask.md) in the Sheet Options. Remember that the Sheet Options can be access by tapping the yellow ball in the upper left corner.

### Editing values in the Tracking Sheet

The cue numbers can be renumbered by editing the number. Read more about this function the [Looking at the cue sequence topic](Looking%20at%20the%20Cue%20Sequence.md).
...
![](../../img/popup_tracking-options_v3-3.png)
...
← [Playing back Cues](Playing%20back%20Cues.md) | [Update cues](Update%20cues.md) →
