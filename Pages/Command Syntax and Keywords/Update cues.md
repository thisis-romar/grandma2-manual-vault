...
prev_page: "[Pages/Command Syntax and Keywords/Looking at the cue content](Looking%20at%20the%20cue%20content.md)"
next_page: "[Pages/Command Syntax and Keywords/What is Tracking](What%20is%20Tracking.md)"
depth: 2
tags:
  - "type/page"
  - "section/cs"
...
> [!source]- Source
> [MA Lighting Help – Update cues](https://help.malighting.com/grandMA2/en/help/key_cs_update_cues.html)
...
*   **Tracking update**, **Update Cue Only**, or **Update Tracking Shield** (Cue section only):  
     
*   **Save as Default**:  
...
Please read details about Presets and Effects in the [Preset section](../../Sections/Presets.md) and the [Effect section](../../Sections/Effects.md). These include explanations of the different relevant options.
...
It is also possible to change the values directly in the Sequence Tracking Sheet and the Sequence Content Sheet. These two sheets and the editing process are described in the [Looking at the Cue Content topic](Looking%20at%20the%20cue%20content.md).

← [Looking at the cue content](Looking%20at%20the%20cue%20content.md) | [What is Tracking](What%20is%20Tracking.md) →
