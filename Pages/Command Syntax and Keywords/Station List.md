...
prev_page: "[Pages/Command Syntax and Keywords/Attribute List](Attribute%20List.md)"
depth: 3
tags:
  - "type/page"
  - "section/cs"
...
For more information on how to set the IP address see [SetIP](../../Keywords/SetIP.md).

← [Attribute List](Attribute%20List.md)
