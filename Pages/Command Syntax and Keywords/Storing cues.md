...
prev_page: "[Pages/Command Syntax and Keywords/Looking at the Cue Sequence](Looking%20at%20the%20Cue%20Sequence.md)"
next_page: "[Pages/Command Syntax and Keywords/Store Options and Defaults](Store%20Options%20and%20Defaults.md)"
depth: 2
tags:
  - "type/page"
  - "section/cs"
summary: "Storing cues is actually quite simple."
---

# Storing cues

> [!source]- Source
> [MA Lighting Help – Storing cues](https://help.malighting.com/grandMA2/en/help/key_cs_store.html)
...
Read more about then in the [World, Filters, and Mask section](../../Sections/Worlds%20Filters%20and%20Masks.md).
...
![](../../img/popup_choose-store-method_second-cue_v3-3.png)
...
Over write and the two merge options are explained below. Remove and Release are covered in the [What is Tracking topic](What%20is%20Tracking.md).
...
![](../../img/popup_choose-store-method_v3-3.png)

_Choose store method pop-up_

It only appears if you have not specified what should happen. Have a look at the [Store Options and Defaults topic](Store%20Options%20and%20Defaults.md) for information about specifying this while storing.

"Cue Only", "Tracking Shield", "Remove", and "Release" are described in the [What is Tracking topic](What%20is%20Tracking.md).
...
In the following examples we have a cue list with the following two cues (looking at the Sequence Tracking Sheet - read about it [here](Looking%20at%20the%20cue%20content.md)):
...
![](../../img/window_sequence-tracking-sheet_two-cues-after-overwrite_v3-3.png)
...
![](../../img/window_sequence-tracking-sheet_two-cues-after-merge_v3-3.png)
...
![](../../img/window_sequence-tracking-sheet_two-cues-after-status-merge_v3-3.png)
...
When storing a cue it is possible to also store the different cue timings. This is described in detail the [Cue Timings topic](Cue%20timings.md), but here is the short version.
...
![](../../img/window_sequence-tracking-sheet_five-cues-before-storing_v3-3.png)
...
![](../../img/window_sequence-tracking-sheet_five-cues-after-storing_v3-3.png)
...
![](../../img/window_sequence-tracking-sheet_two-cues-with-part_v3-3.png)
...
The second press on the cue key will result in the [Part keyword](../../Keywords/Part.md) and the command line feedback looks like this:
...
The command line gives access to all the store options that can be found in the GUI Store Options - read about them in the [Store Options and Defaults topic](Store%20Options%20and%20Defaults.md).

All the different elements are described in the [Store Keyword topic](../../Keywords/Store.md).
...
For removal of a few values, the Sequence Tracking Sheet or Sequence Content Sheets might be good tools. Read about them in the [Looking at the Cue Content topic](Looking%20at%20the%20cue%20content.md).

← [Looking at the Cue Sequence](Looking%20at%20the%20Cue%20Sequence.md) | [Store Options and Defaults](Store%20Options%20and%20Defaults.md) →
