...
prev_page: "[Pages/Command Syntax and Keywords/Update cues](Update%20cues.md)"
next_page: "[Pages/Command Syntax and Keywords/What is MIB](What%20is%20MIB.md)"
depth: 2
tags:
  - "type/page"
  - "section/cs"
summary: "Tracking is the principle to only store the changes in the cues."
---

# What is Tracking

> [!source]- Source
> [MA Lighting Help – What is Tracking](https://help.malighting.com/grandMA2/en/help/key_cs_what_is_tracking.html)
...
The best way to see this information is the [Tracking Sheet](Looking%20at%20the%20cue%20content.md). It would look like this:
...
![](../../img/window_sequence-tracking-sheet_eight-cues_cue-4-blocked_v3-3.png)
...
![](../../img/window_sequence-tracking-sheet_eight-cues_cue-4_v3-3.png)
...
![](../../img/window_sequence-tracking-sheet_five-cue_before-change_v3-3.png)
...
![](../../img/window_sequence-tracking-sheet_five-cue_cue-only-change_v3-3.png)
...
![](../../img/window_sequence-tracking-sheet_five-cue_change-without-cueonly_v3-3.png)
...
If a different sequence is sending values to the attribute then these values are now used. Sequence priority can be important in this case - read about priorities in the [Playing back Cues topic](Playing%20back%20Cues.md). 

## Release First Step

There is an option in the [Executor Options](../Advanced%20Executor%20Functionality/Executor%20Options.md) that is called **Release Firststep**. This becomes relevant if another option called **Wrap Around** is active. 
...
![](../../img/window_sequence-tracking-sheet_five-cue_no-tracking_v3-3.png)
...
← [Update cues](Update%20cues.md) | [What is MIB](What%20is%20MIB.md) →
