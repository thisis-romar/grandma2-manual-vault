...
prev_page: "[Pages/Command Syntax and Keywords/Storing cues](Storing%20cues.md)"
next_page: "[Pages/Command Syntax and Keywords/Cue timings](Cue%20timings.md)"
depth: 2
tags:
  - "type/page"
  - "section/cs"
...
In this topic the options regarding storing cues are described. Some of these options will impact how other cues will respond. Elements regarding tracking are described in the [What is Tracking topic](What%20is%20Tracking.md).
...
The "Presets" options are described in the [Create Presets topic](../Presets/Create%20Presets.md). "If not Empty" is described in the [Store Cues topic](Storing%20cues.md).

**Store Filter** is described in the [What are Filters topics](../Worlds%20Filters%20and%20Masks/What%20are%20filters.md). **Cue Only** and **Tracking Shield** is discussed in the [What is Tracking topic](What%20is%20Tracking.md). Position data (**Active Position Data**, **XYZ**, and **Pan/Tilt**) is relevant when XYZ position programming is activated. Read more about it in the [Programming XYZ section](../../Sections/XYZ.md).
...
*   **Output:**  
    Stores the status of the current output from the console. The output can be affected by masters and DMX profiles. The [DMX sheet](../Patching/DMX%20Sheet.md) will show what the output actually is. 
*   **DMX In:**  
...
*   **If not Empty:**  
    This is the if not empty swipe button - read description in the [Store Cues topic](Storing%20cues.md).
*   **Store Filter:**  
    This button opens the Store Filter pop-up - read about it in the [Use Temporary Filters topic](../Worlds%20Filters%20and%20Masks/Use%20temporary%20filters.md).
*   **Value Layers:**  
    This on/off button filters the Value Layers - read about the layers in the [Layers in Sheets topic](../Operate%20Fixtures/Layer%20in%20Sheets.md).
*   **Value Time Layers:**  
...
*   **Cue Only:**  
    This on/off button will activate the Cue Only function. It is mutually exclusive with the Tracking Shield function. Read about Cue Only in the [What is Tracking topic](What%20is%20Tracking.md).
*   **Tracking Shield:**  
...
← [Storing cues](Storing%20cues.md) | [Cue timings](Cue%20timings.md) →
