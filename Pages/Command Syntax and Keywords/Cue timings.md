...
prev_page: "[Pages/Command Syntax and Keywords/Store Options and Defaults](Store%20Options%20and%20Defaults.md)"
next_page: "[Pages/Command Syntax and Keywords/Renumber cues](Renumber%20cues.md)"
depth: 2
tags:
  - "type/page"
  - "section/cs"
...
> [!source]- Source
> [MA Lighting Help – Cue timings](https://help.malighting.com/grandMA2/en/help/key_cs_cue_timings.html)
...
There is also manual cross fading. This overwrites any timing. Read more about cross fading in the [Playing back Cues topic](Playing%20back%20Cues.md).

## General Cue Timing

This is the general timing columns that can be seen in the [Sequence Executor Sheet](Looking%20at%20the%20Cue%20Sequence.md).
...
![](../../img/img_encoder-toolbar_value_v3_3.png)
...
![](../../img/img_encoder-toolbar_fade_active-values_v3_3.png)
...
Depending on what is stored with individual times, please consider if using [Part Cues](Storing%20cues.md) might be a better solution for you.

## Rate Fader

All executors have a Rate Fader. This fader might not be assigned to a physical fader but it is still there. For details about this please have a look at the [Executors section](../../Sections/Executors.md).
...
![](../../img/window_sequence-executor-sheet_rate-adjusted_v3-3.png)
...
It is possible to activate **Ignore Exec Time** in the options for each Executor - see the [Executor Options topic](../Advanced%20Executor%20Functionality/Executor%20Options.md). This will exclude the executor from being effected by the Exec Time.
...
← [Store Options and Defaults](Store%20Options%20and%20Defaults.md) | [Renumber cues](Renumber%20cues.md) →
