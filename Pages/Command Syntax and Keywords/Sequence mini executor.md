...
cssclasses:
  - "gma2-page"
title_str: "Sequence mini executor"
...
prev_page: "[Pages/Command Syntax and Keywords/What is MIB](What%20is%20MIB.md)"
next_page: "[Pages/Command Syntax and Keywords/Commands in cues](Commands%20in%20cues.md)"
depth: 2
tags:
  - "type/page"
  - "section/cs"
summary: "When a sequence is assigned to an executor, the mini executor view is displaying relevant information."
---

# Sequence mini executor

> [!source]- Source
> [MA Lighting Help – Sequence mini executor](https://help.malighting.com/grandMA2/en/help/key_cs_sequence_mini_executor.html)
...
The top line has a number on the left side. This number is the **executor** number. If this number has a different background color, then there is a [Playback filter](../Worlds%20Filters%20and%20Masks/Apply%20worlds%20or%20filters%20to%20executors%20and%20sequences.md) applied.
...
*   **T:**  
    The "T" is there if the sequence is set as a tracking sequence. Read about tracking in the [What is Tracking topic](What%20is%20Tracking.md).

The different priorities are described in the [Playing back Cues topic](Playing%20back%20Cues.md).

On the right side there is another number. This is the **sequence** number. If this number has a different background color, then there is a [Input filter](../Worlds%20Filters%20and%20Masks/Apply%20worlds%20or%20filters%20to%20executors%20and%20sequences.md) applied.
...
Pressing or clicking in this area will open a temporary [Sequence Executor window](Looking%20at%20the%20Cue%20Sequence.md).

The middle part can look very different if it is "located" using the [Locate command](../../Keywords/Locate.md). It will look like this:
...
![](../../img/img_mini-executor_sequence_playback-master_v3_3.png)

_Mini Executor - Sequences - With Playback Master_

This happens if the executor have a Playback Master assigned - Read about Playback Masters in the [Playback Masters topic](../Advanced%20Executor%20Functionality/Playback%20Masters.md). 
...
![](../../img/img_mini-executor_sequence_two-wide_v3-3.png)

_Two wide executor_

Read about making wider executors in the [Assign a Function topic](../Executors/Assign%20a%20function.md).

← [What is MIB](What%20is%20MIB.md) | [Commands in cues](Commands%20in%20cues.md) →
