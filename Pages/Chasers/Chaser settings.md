...
section_ref: "[Sections/Chasers](../../Sections/Chasers.md)"
prev_page: "[Pages/Chasers/Create a chaser](Create%20a%20chaser.md)"
next_page: "[Pages/Chasers/Chaser mini executor](Chaser%20mini%20executor.md)"
depth: 2
tags:
  - "type/page"
  - "section/chaser"
...
 Edit Current,  Edit Previous and Edit Next buttons edits cues. For more information, see the topic [Looking at the cue sequence](../Command%20Syntax%20and%20Keywords/Looking%20at%20the%20Cue%20Sequence.md).
...
*   **Speed 1** through **Speed 15** limits the speed of the chaser by a **Speed Master**. This is useful to keep the chaser in sync with other chasers and effects. For more information, see [Assign a Function](../Executors/Assign%20a%20function.md).
*   The **BPM** option measures the Beat from the Audio In signal. For more information, see [Sound In](../Other%20System%20Tools/Sound%20input%20window.md).
...
← [Create a chaser](Create%20a%20chaser.md) | [Chaser mini executor](Chaser%20mini%20executor.md) →

Part of [Chasers](../../Sections/Chasers.md) · [000 Map of Content](../../000%20Map%20of%20Content.md)
