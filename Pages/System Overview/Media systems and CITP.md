...
prev_page: "[Pages/System Overview/Big systems](Big%20systems.md)"
depth: 2
tags:
  - "type/page"
  - "section/so"
...
> [!source]- Source
> [MA Lighting Help – Media systems and CITP](https://help.malighting.com/grandMA2/en/help/key_so_media_systems_and_citp.html)
...
For more about getting thumbnails via CITP have a look at the [CITP connection](../Networking/Using%20CITP.md) topic.

Have a look at the description of the [CITP viewer](../Networking/Streaming%20CITP%20video.md) to learn more about watching a CITP video stream on the console.

Some visualizers can also display the CITP video stream from media systems.

← [Big systems](Big%20systems.md)
