...
prev_page: "[Pages/Backup Menu/Create a new show](Create%20a%20new%20show.md)"
next_page: "[Pages/Backup Menu/Saving a show](Saving%20a%20show.md)"
depth: 2
tags:
  - "type/page"
  - "section/backup"
...
It is also possible to see the information that has been saved into the show by the users. Read more about this in [Save Show topic](Saving%20a%20show.md).
...
Show files can be loaded using the command line. The command is called LoadShow. Read more about it [here](../../Keywords/LoadShow.md).

← [Create a new show](Create%20a%20new%20show.md) | [Saving a show](Saving%20a%20show.md) →
