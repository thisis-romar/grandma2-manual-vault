...
next_page: "[Pages/Backup Menu/Loading a show](Loading%20a%20show.md)"
depth: 2
tags:
  - "type/page"
  - "section/backup"
...
> [!source]- Source
> [MA Lighting Help – Create a new show](https://help.malighting.com/grandMA2/en/help/key_backup_menu_new_show.html)
...
Pressing the ![](../../img/icon_cross_v3-2.png) opens an on-screen keyboard.
...
It is possible to create a new show using the command line. The command is called NewShow. Read more about it [here](../../Keywords/NewShow.md).

[Loading a show](Loading%20a%20show.md) →
