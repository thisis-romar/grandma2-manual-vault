...
cssclasses:
  - "gma2-page"
title_str: "grandMA2 to grandMA3 Show File Converter"
...
prev_page: "[Pages/Backup Menu/ASCII Show Read](ASCII%20Show%20Read.md)"
depth: 2
tags:
  - "type/page"
  - "section/backup"
...
> [!source]- Source
> [MA Lighting Help – grandMA2 to grandMA3 Show File Converter](https://help.malighting.com/grandMA2/en/help/key_backup_menu_save_as_grandma3.html)
...
If the button Save as grandMA3 x.x.x is not visible, the system requirements for this feature are not fulfilled. For more information, see [system requirements](../Introduction/System%20Requirements%20grandMA2%20onPC.md).
...
← [ASCII Show Read](ASCII%20Show%20Read.md)
