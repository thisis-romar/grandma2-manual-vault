...
prev_page: "[Pages/Backup Menu/Partial Show Read](Partial%20Show%20Read.md)"
next_page: "[Pages/Backup Menu/grandMA2 to grandMA3 Show File Converter](grandMA2%20to%20grandMA3%20Show%20File%20Converter.md)"
depth: 2
tags:
  - "type/page"
  - "section/backup"
...
> [!source]- Source
> [MA Lighting Help – ASCII Show Read](https://help.malighting.com/grandMA2/en/help/key_backup_menu_ascii_show_read.html)
...
![](../../img/popup_ascii-show-read_overview_v3-2.png)
...
![](../../img/popup_ascii-show-read_attribute_v3-2.png)
...
Attributes that does not exist can be created in the [Attributes and Encoder Grouping](../Patching/What%20are%20Attributes.md) window.
...
Importing from the show file will create different log files. These files can be seen in the three remaining tabs. The log files also exists in the "temp" folder in the consoles structure. To get to them a FTP connection is needed. Read about it in the [FTP Connection to Console and NPU topic](../Networking/FTP%20connection%20to%20console%20and%20NPU.md).

← [Partial Show Read](Partial%20Show%20Read.md) | [grandMA2 to grandMA3 Show File Converter](grandMA2%20to%20grandMA3%20Show%20File%20Converter.md) →
