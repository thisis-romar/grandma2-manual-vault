...
> [!source]- Source
> [MA Lighting Help – Manage pool objects](https://help.malighting.com/grandMA2/en/help/key_pools_manage.html)
...
![](../../img/window_goup-pool_empty-pool-object_v3-2.png)

_Groups pool - empty pool object_
...
1.  Press Assign Assign (= Label) and tap at the to be labeled group object tile.  
    \- or -  
    Press Assign Assign (= Label) Group 17 Please.
    
    ![](../../img/popup_enter-name-for-group_v3_2.png)
    
    _Enter Name for Group pop-up_
    
2.  Use a keyboard or open the virtual keyboard by tapping at the **plus** ![](../../img/icon_plus_small_v3-2.png) to enter the new group name in the green edit line for example **Backtruss**.
3.  Press Please.

![](../../img/window_goup-pool_labeled-pool-object_v3-2.png)

_Group pool - labeled empty pool object_
...
![](../../img/window_goup-pool_copied-pool-object_v3-2.png)

_Group pool - copied pool object_
...
**Restriction:**  
The Pages Channel Pool, the Pages Exec Pool, and the Views Pool does not support the Edit pool objects function.
...
**Important:**  
You can unlock only pool objects indicated by a yellow lock ![](../../img/icon_yellow-lock_small_v3-2.png).
...
**Hint:**  
You can also use the Unlock keyword to unlock pool objects.
