...
cssclasses:
  - "gma2-page"
title_str: "Use Predefined Effects"
...
next_page: "[Pages/Effects/Use Template and Selective Effects](Use%20Template%20and%20Selective%20Effects.md)"
depth: 2
tags:
  - "type/page"
  - "section/effects"
...
> [!source]- Source
> [MA Lighting Help – Use Predefined Effects](https://help.malighting.com/grandMA2/en/help/key_effects_predefined.html)
...
*   Import predefined effects.  
    For more information on how to import effects see [Import via user interface](../Export%20and%20Import/Export%20by%20using%20user%20interface.md). 
...
![](../../img/window_predefined-effect-pool_v3-3.png)
...
![](../../img/popup_effect-editor_v3-3.png)
...
![](../../img/popup_select-interleave_predefined-effects_v3-3.png)
...
![](../../img/popup_select-effect-attributes_v3-3.png)
...
*   **Mode:**  
    The column mode corresponds to the effect [modes absolute and relative](../../Sections/Effects.md).
...
![](../../img/popup_select-form_predefined-effects_v3-3.png)
...
**Important:**  
Using the effect on a speed master overwrites the speed set in an executor. For more information on the speed in an executor see [Advanced Executor Functionality – Speed masters](../Advanced%20Executor%20Functionality/Speed%20Masters.md). 
...
![](../../img/popup_select-speed-rate-master_effects_v3-3.png)
...
![](../../img/popup_select-dir_effects_v3-3.png)
...
![](../../img/popup_calculator_low-values_effects_v3-3.png)
...
![](../../img/popup_calculator_phase_effect_v3-3.png)
...
![](../../img/popup_calculator_edit-width_effects_v3-3.png)
...
![](../../img/popup_calculator_edit-groups_effects_v3-3.png)
...
For more information on the keyword see [RemoveIndividuals](../../Keywords/RemoveIndividuals.md).
...
![](../../img/popup_effect-editor_remove-individuals_v3-3.png)

_Effect editor displaying individual values_

If you tap Remove Individuals, a warning appears.

![](../../img/popup_warning-remove-individuals_effects_v3-3.png)

_Warning pop-up – remove individuals_

To close the pop-up, tap Cancel or ![](../../img/icon_close_small_v3-2.png) in the upper right corner of the pop-up. 
...
![](../../img/popup_effect-line-editor_v3-3.png)

_Pop-up – effect line editor_

**Hint:**  
It is also possible to select and deselect the attributes on the right of the effect line editor, right below the ![](../../img/icon_close_small_v3-2.png). 
...
5.  The button is now toggled to Preset. For more information on effects that use presets see [Create an effect that uses presets](Create%20an%20Effect%20that%20Uses%20Presets.md). 
...
[Use Template and Selective Effects](Use%20Template%20and%20Selective%20Effects.md) →
