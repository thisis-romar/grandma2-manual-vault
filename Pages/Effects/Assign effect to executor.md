...
prev_page: "[Pages/Effects/Effects in a Cue](Effects%20in%20a%20Cue.md)"
next_page: "[Pages/Effects/Live Edit an Effect](Live%20Edit%20an%20Effect.md)"
depth: 2
tags:
  - "type/page"
  - "section/effects"
...
> [!source]- Source
> [MA Lighting Help – Assign effect to executor](https://help.malighting.com/grandMA2/en/help/key_effects_assign_to_executor.html)

Version 3.9

# Assign effect to executor

It is possible to assign effects to executors. 
...
![](../../img/img_effect-assigned-on-executor_effects_v3-3.png)

_Selective effect assigned to an executor_

Much the same as other mini executors, the effect mini executor is divided into different sections. For more information on the general sections see [Sequence mini executor](../Command%20Syntax%20and%20Keywords/Sequence%20mini%20executor.md). 

* * *

## Sections Corresponding to the Effect Mini Executor

The third line (displaying BPM) and the forth line (displaying s) correspond to the speed master. 

![](../../img/img_effect-assigned-on-executor_speed-master_v3-3.png)
...
**Important:**  
If you tap the upper area of the mini executor, the [assign menu](../Executors/Assign%20a%20function.md) opens.  
Tapping the lower area of the mini executor opens the [effect editor](Use%20Predefined%20Effects.md).

Generally speaking, the speed of an executor influences the speed of an effect. For more information on the speed master in an executor see [Speed Masters](../Advanced%20Executor%20Functionality/Speed%20Masters.md). 
...
← [Effects in a Cue](Effects%20in%20a%20Cue.md) | [Live Edit an Effect](Live%20Edit%20an%20Effect.md) →
