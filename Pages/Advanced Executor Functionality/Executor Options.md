...
prev_page: "[Pages/Advanced Executor Functionality/Channel Pages](Channel%20Pages.md)"
next_page: "[Pages/Advanced Executor Functionality/Masters Window](Masters%20Window.md)"
depth: 2
tags:
  - "type/page"
  - "section/adv"
...
The Auto Start function is described in the [Common Executor Options topic](../Executors/Common%20executor%20options.md).

**Auto Stop**

The Auto Stop function is described in the [Common Executor Options topic](../Executors/Common%20executor%20options.md).

**Auto Stop Off Time**

The Auto Stop Off Time function is described in the [Common Executor Options topic](../Executors/Common%20executor%20options.md).
...
The MasterGo function is described in the [Common Executor Options topic](../Executors/Common%20executor%20options.md).

**Loop BreakingGo**

Loop BreakingGo is described in the [Looping Cues topic](../Advanced%20Sequence%20Functionality/Looping%20cues.md).

## Playback

**Priority**

The priorities are described in the [Playing Back Cue topic](../Command%20Syntax%20and%20Keywords/Playing%20back%20Cues.md).

**Soft LTP**

The Soft LTP function is described in the [Playing Back Cue topic](../Command%20Syntax%20and%20Keywords/Playing%20back%20Cues.md).

**Playback Master**

Here it is possible to select a Playback Master. This is all described in the [Playback Master topic](Playback%20Masters.md).

**Wrap Around**

The Wrap around function is described in the [What is Tracking topic](../Command%20Syntax%20and%20Keywords/What%20is%20Tracking.md).

**Restart**

The Restart function is described in the [Common Executor Options topic](../Executors/Common%20executor%20options.md).
...
The playback filter is described in the [Apply Worlds or Filters to Executors and Sequences topic](../Worlds%20Filters%20and%20Masks/Apply%20worlds%20or%20filters%20to%20executors%20and%20sequences.md).
...
The Tracking function is described in the [What is Tracking topic](../Command%20Syntax%20and%20Keywords/What%20is%20Tracking.md).

**Release Firststep**

The Release Firststep function is described in the [What is Tracking topic](../Command%20Syntax%20and%20Keywords/What%20is%20Tracking.md).

**Cue Zero**

The Cue Zero function is described in the [Cue Zero topic](../Advanced%20Sequence%20Functionality/Cue%20Zero.md).
...
It is possible to force the sequence to use only XYZ values or Pan/Tilt values when moving from one position to another. The default is Active position data. This will use the stored position data. Read more in the  [XYZ vs. Pan/Tilt topic](../XYZ/XYZ%20vs.%20Pan-Tilt.md).

**Timecode**

A sequence can have a link to the selected Timecode Slot or a specific Timecode Slot. This can be chosen here. It is relevant if there are cues that uses the timecode signal as the trigger. Read more about timecode in the [Timecode section](../../Sections/Timecode.md).
...
Read more details in the [Speed Masters topic](Speed%20Masters.md).
...
Read more details in the [Rate Masters topic](Rate%20Masters.md).
...
This setting will link the effect speed to the rate. Read more about effects and speed in the [Effects section](../../Sections/Effects.md).
...
When enabled, it will make the executor use the stored timing and not allow the Exec Time fader to overwrite the timing. The Exec Time fader is described in the [Time Control Topic](../Workspace/Time%20Control.md).

**Off On Overwritten**

The Off On Overwritten function is described in the [Common Executor Options topic](../Executors/Common%20executor%20options.md).

## MIB

Move In Black is described in [Working with MIB topic](../Advanced%20Sequence%20Functionality/Working%20with%20MIB.md).
...
This will turn the sequence into a Chaser. Read more about chaser in the [Chasers section](../../Sections/Chasers.md).

**Group Master Mode**

This option is only visible if there is an group master assigned to the executor. This option is explained in the [Group Masters topic](../Groups/Group%20Master%20on%20Executors.md).

← [Channel Pages](Channel%20Pages.md) | [Masters Window](Masters%20Window.md) →
