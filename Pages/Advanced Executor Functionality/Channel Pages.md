...
prev_page: "[Pages/Advanced Executor Functionality/Executor Pages](Executor%20Pages.md)"
next_page: "[Pages/Advanced Executor Functionality/Executor Options](Executor%20Options.md)"
depth: 2
tags:
  - "type/page"
  - "section/adv"
summary: "The Fader Executors can be changed to be Channel Faders instead of Executors."
---

# Channel Pages

> [!source]- Source
> [MA Lighting Help – Channel Pages](https://help.malighting.com/grandMA2/en/help/key_adv_exec_ch_pages.html)
...
![](../../img/window_channel-pool_v3-3.png)

_Channel page pool_

This works as any of the pool - if you have not read the [Pools in General section](../../Sections/Pools.md), then please read it.

This is what it looks like in Sheet Style:

![](../../img/window_channel-pool_sheet-style_v3-3.png)
...
Tapping one of the objects in the pool will change to the Channel page. It is also possible to change the page using the Ch Pg + and Ch Pg - keys or the [ChannelPage](../../Keywords/ChannelPage%20keyword.md) command. Keeping the Ch Pg -  key pressed for a second will jump back to page number 1.
...
![](../../img/menu_auto-create_channel-pages_v3-3.png)
...
The Dynamic Channel Pages can be accessed when the [Channel Sheets](../Operate%20Fixtures/Channel%20Sheet.md) and the [Fixture Sheets](../Operate%20Fixtures/Fixture%20Sheet.md) have activated the **Link Faders** option. Read more about activating this in the [Title Buttons topic](../Operate%20Fixtures/Title%20buttons.md).

Dynamic Channel Pages can also be called using the [ChannelLink](../../Keywords/ChannelLink%20keyword.md) command.
...
← [Executor Pages](Executor%20Pages.md) | [Executor Options](Executor%20Options.md) →
