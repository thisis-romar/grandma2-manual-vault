...
prev_page: "[Pages/Control MA Network Switch/Change switch ID](Change%20switch%20ID.md)"
next_page: "[Pages/Control MA Network Switch/Edit groups of the MA Network Switch](Edit%20groups%20of%20the%20MA%20Network%20Switch.md)"
depth: 2
tags:
  - "type/page"
  - "section/control"
...
> [!source]- Source
> [MA Lighting Help – Configure ports of the MA Network Switch](https://help.malighting.com/grandMA2/en/help/key_control_ma_switch_ports.html)
...
If no manage port is in the network you can not configure the switch anymore. A [factory reset](Reset%20the%20MA%20Network%20Switch%20to%20its%20factory%20defaults.md) is necessary.
...
If a port is connected, the link LED is blinking in the speed color. For more information see [MA Network Switch manual](/Page/Network/MA_network_switch/en/3.1).
...
Configure the LAGs via the web interface or in the [MA Network Configuration menu – Edit LAGs](Edit%20Link%20Aggregation%20Groups%20of%20the%20MA%20Network%20Switch.md). For more information see [MA Network Switch](/Page/Network/MA_network_switch/en/3.3). 
...
3.  Tap and hold in the cell of a port or tap in the cell and press the screen encoder.  
    ...
    ![](../../img/popup_configure-switch-port_v3_2.png)
...
← [Change switch ID](Change%20switch%20ID.md) | [Edit groups of the MA Network Switch](Edit%20groups%20of%20the%20MA%20Network%20Switch.md) →
