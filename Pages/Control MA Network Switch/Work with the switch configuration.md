...
prev_page: "[Pages/Control MA Network Switch/Mirror Ports of the MA Network Switch](Mirror%20Ports%20of%20the%20MA%20Network%20Switch.md)"
next_page: "[Pages/Control MA Network Switch/Disable SNMP](Disable%20SNMP.md)"
depth: 2
tags:
  - "type/page"
  - "section/control"
...
> [!source]- Source
> [MA Lighting Help – Work with the switch configuration](https://help.malighting.com/grandMA2/en/help/key_control_ma_switch_configuration.html)
...
*   [Added MA Network Switch to the network configuration](Add%20the%20MA%20Network%20Switch%20to%20the%20network%20configuration.md)
...
3.  Tap Configuration.  
    ...
    ![](../../img/popup_network-switch-configuration_v3_2.png)
...
4.  Tap Get Configuration.  
    ...
    ![](../../img/popup_save-configuration_v3_2.png)
    
    _Save Configuration pop-up_
    
5.  Select drive and folder and type the file name in the green edit line. Tap at the **plus** ![](../../img/icon_plus_small_v3-2.png) to open the virtual keyboard.
6.  Tap Save.
...
4.  Tap Send Configuration.  
    ...
    ![](../../img/popup_load-configuration_v3_2.png)
...
← [Mirror Ports of the MA Network Switch](Mirror%20Ports%20of%20the%20MA%20Network%20Switch.md) | [Disable SNMP](Disable%20SNMP.md) →
