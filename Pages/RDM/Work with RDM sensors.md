...
prev_page: "[Pages/RDM/Work with RDM parameters](Work%20with%20RDM%20parameters.md)"
next_page: "[Pages/RDM/Configure RDM notifications](Configure%20RDM%20notifications.md)"
depth: 2
tags:
  - "type/page"
  - "section/rdm"
...
Hint:  
You can also monitor the RDM sensors by using the [RDMInfo keyword](../../Keywords/RdmInfo.md).
...
← [Work with RDM parameters](Work%20with%20RDM%20parameters.md) | [Configure RDM notifications](Configure%20RDM%20notifications.md) →
