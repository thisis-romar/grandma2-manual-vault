...
cssclasses:
  - "gma2-page"
title_str: "Configure RDM notifications"
slug: "key_rdm_notifications"
url: "https://help.malighting.com/grandMA2/en/help/key_rdm_notifications.html"
section: "RDM"
ma2_section: "key_rdm"
section_ref: "[Sections/RDM](../../Sections/RDM.md)"
prev_page: "[Pages/RDM/Work with RDM sensors](Work%20with%20RDM%20sensors.md)"
next_page: "[Pages/RDM/Use the RDM sheet](Use%20the%20RDM%20sheet.md)"
depth: 2
tags:
  - "type/page"
  - "section/rdm"
...
> [!source]- Source
> [MA Lighting Help – Configure RDM notifications](https://help.malighting.com/grandMA2/en/help/key_rdm_notifications.html)
...
*   [Layout View](../../Sections/Layouts.md)
*   [Command line](../Workspace/Command%20Line.md)

The RDM notifications themselves are displayed in the:

*   [Message Center](../Other%20System%20Tools/Message%20center.md)
*   RDM Messages, go to **Setup -> Patch & Fixture Schedule -> RDM Devices -> RDM Info -> Messages** or type [RdmInfo](../../Keywords/RdmInfo.md) in the command line and tap **Messages**.
...
1.  Open the **Fixture Type Editor**.  
    ...
    ![](../../img/menu_channels-of-module_v3_2.png)
...
3.  The **Configure RDM Notifications window** opens.  
    ...
    ![](../../img/menu_configure-rdm-notifications_v3_2.png)
...
4.  Tap Add or tap in the cell of the column Type and press the screen encoder.  
    ...
    ![](../../img/popup_select-rdm-notification-type_v3-2.png)
...
5.  Tap at Parameter or Sensor, depending for what type you want to add an RDM notification. To edit the next cell, tap at the Parameter/Sensor ID cell and press the screen encoder.  
    ...
    ![](../../img/popup_select-rdm-notification-id_v3-2.png)
...
6.  Tap at the Parameter or Sensor you like to add an RDM notification for. To edit the next cell, tap at the Threshold Operator cell and press the screen encoder.  
    ...
    ![](../../img/popup_select-rdm-notification-threshold-operator_v3-2.png)
...
8.  Enter the threshold value in the calculator. The title bar displays the allowed value range. To edit the next cell, tap at the Notification Type cell and press the screen encoder.  
    ...
    ![](../../img/popup_select-rdm-notification-type_warning_v3-2.png)
...
1.  Open the **Configure RDM Notifications window**.  
    ...
    ![](../../img/menu_configure-rdm-notifications-with-sensor_v3_2.png)
...
← [Work with RDM sensors](Work%20with%20RDM%20sensors.md) | [Use the RDM sheet](Use%20the%20RDM%20sheet.md) →

Part of [RDM](../../Sections/RDM.md) · [000 Map of Content](../../000%20Map%20of%20Content.md)
