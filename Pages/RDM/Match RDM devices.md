...
cssclasses:
  - "gma2-page"
title_str: "Match RDM devices"
slug: "key_rdm_match"
url: "https://help.malighting.com/grandMA2/en/help/key_rdm_match.html"
section: "RDM"
ma2_section: "key_rdm"
section_ref: "[Sections/RDM](../../Sections/RDM.md)"
prev_page: "[Pages/RDM/Turn RDM on](Turn%20RDM%20on.md)"
next_page: "[Pages/RDM/Auto Patch RDM Devices](Auto%20Patch%20RDM%20Devices.md)"
depth: 2
tags:
  - "type/page"
  - "section/rdm"
...
> [!source]- Source
> [MA Lighting Help – Match RDM devices](https://help.malighting.com/grandMA2/en/help/key_rdm_match.html)
...
When working with parameters only you can skip the match RDM devices topic and continue with the topic [work with RDM parameters](Work%20with%20RDM%20parameters.md).
...
![](../../img/menu_discovered-rdm-devices_v3_2.png)
...
6.  If you have the to be matched fixture selected in the table tap at Match to Fixture.  
    ...
    ![](../../img/menu_match-to-ma-fixture_v3_2.png)
...
**Hint:**  
You can also use the [keyword RdmAutomatch](../../Keywords/RdmAutomatch.md) to auto-match RDM devices by using the command line.

← [Turn RDM on](Turn%20RDM%20on.md) | [Auto Patch RDM Devices](Auto%20Patch%20RDM%20Devices.md) →
