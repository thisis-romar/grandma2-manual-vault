...
prev_page: "[Pages/Worlds Filters and Masks/Create worlds](Create%20worlds.md)"
next_page: "[Pages/Worlds Filters and Masks/Use worlds when programming](Use%20worlds%20when%20programming.md)"
depth: 2
tags:
  - "type/page"
  - "section/wfm"
...
If this is off, and if there is a conflict, then a Auto Create Conflict pop-up appears - read about it in the [Auto Create Groups topic](../Groups/Auto%20Create%20groups.md).
...
← [Create worlds](Create%20worlds.md) | [Use worlds when programming](Use%20worlds%20when%20programming.md) →
