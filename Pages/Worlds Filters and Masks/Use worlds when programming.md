...
cssclasses:
  - "gma2-page"
title_str: "Use worlds when programming"
...
prev_page: "[Pages/Worlds Filters and Masks/Auto create worlds](Auto%20create%20worlds.md)"
next_page: "[Pages/Worlds Filters and Masks/What are filters](What%20are%20filters.md)"
depth: 2
tags:
  - "type/page"
  - "section/wfm"
summary: "Worlds are a great tool when programming."
---

# Use worlds when programming

> [!source]- Source
> [MA Lighting Help – Use worlds when programming](https://help.malighting.com/grandMA2/en/help/key_wfm_use_worlds.html)
...
But you can assign a world to an executor or a sequence. Read more about that in the [Apply worlds or filters to executors and sequences topic](Apply%20worlds%20or%20filters%20to%20executors%20and%20sequences.md).

← [Auto create worlds](Auto%20create%20worlds.md) | [What are filters](What%20are%20filters.md) →
