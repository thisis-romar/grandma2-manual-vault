...
prev_page: "[Pages/Worlds Filters and Masks/What are Worlds](What%20are%20Worlds.md)"
next_page: "[Pages/Worlds Filters and Masks/Auto create worlds](Auto%20create%20worlds.md)"
depth: 2
tags:
  - "type/page"
  - "section/wfm"
...
> [!source]- Source
> [MA Lighting Help – Create worlds](https://help.malighting.com/grandMA2/en/help/key_wfm_create_worlds.html)
...
1.  Select fixture 1 Thru 5 (or any 5 fixtures in your show).
2.  Press Store followed by an empty world in the **World Pool**.
3.  Tap the new world.

You will now only have programming access to fixture 1 thru 5, which is reflected by the [Fixture Sheet Window](../Operate%20Fixtures/Fixture%20Sheet.md). You have access to all attributes.
...
1.  Tap world 1 (Full) in the Worlds Pool.
2.  Select fixture 1 Thru 5 (or any 5 fixtures in your show).
3.  Give the fixtures a dimmer value - does not matter what value.
4.  Press Store followed by an empty world in the World Pool.
5.  Tap the new world.
...
← [What are Worlds](What%20are%20Worlds.md) | [Auto create worlds](Auto%20create%20worlds.md) →
