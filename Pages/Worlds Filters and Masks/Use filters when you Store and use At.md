...
prev_page: "[Pages/Worlds Filters and Masks/Create filters](Create%20filters.md)"
next_page: "[Pages/Worlds Filters and Masks/Use temporary filters](Use%20temporary%20filters.md)"
depth: 2
tags:
  - "type/page"
  - "section/wfm"
...
> [!source]- Source
> [MA Lighting Help – Use filters when you Store and use At](https://help.malighting.com/grandMA2/en/help/key_wfm_use_filter.html)

Version 3.9

# Use filters when you Store and use At

The active filter is used when you store values and data. It is also used when you use the [At command](../../Keywords/At%20keyword.md).
...
As mentioned in the [What are filters topic](What%20are%20filters.md), The filters can be selected and applied. The selected one is the one with the green background and the applied one is the one with a green line above the name.
...
Please also have a look at the [Use temporary filters topic](Use%20temporary%20filters.md) and the [Apply worlds and filters to executors and sequences topic](Apply%20worlds%20or%20filters%20to%20executors%20and%20sequences.md).

← [Create filters](Create%20filters.md) | [Use temporary filters](Use%20temporary%20filters.md) →
