...
cssclasses:
  - "gma2-page"
title_str: "Use temporary filters"
...
prev_page: "[Pages/Worlds Filters and Masks/Use filters when you Store and use At](Use%20filters%20when%20you%20Store%20and%20use%20At.md)"
next_page: "[Pages/Worlds Filters and Masks/What are masks](What%20are%20masks.md)"
depth: 2
tags:
  - "type/page"
  - "section/wfm"
...
> [!source]- Source
> [MA Lighting Help – Use temporary filters](https://help.malighting.com/grandMA2/en/help/key_wfm_temporary_filters.html)
...
The following text describes how to open a temporary filter pop-up. But you can also have the [Command Filter window](Create%20filters.md) on one of your screens and use this.

In the following text we are going to explore the temporary filters using the same examples as in the [Use Filters when programming topic](Use%20filters%20when%20you%20Store%20and%20use%20At.md). If you have not read that, it is a strong suggestion to do that first.

## Temporary Store Filter

You can access the temporary Store filter by pressing the Store key. Now you got the [Store Encoder Toolbar](../Command%20Syntax%20and%20Keywords/Store%20Options%20and%20Defaults.md) visible at the bottom of screen 2. In this toolbar you will find a button called Store Filter. Tapping this will open a filter editor pop-up. It works just as explained in the [Create filters topic](Create%20filters.md). There are two extra buttons on the right side of the pop-up. They are called "Reset Filter on Clear" and "Store Filter and Select".
...
The following example is the same as the one used in the [Use filters when programming topic](Use%20filters%20when%20you%20Store%20and%20use%20At.md).
...
The encapsulation is between the [If command](../../Keywords/If.md) and the [EndIf command](../../Keywords/EndIf.md). EndIf is available as a command using the If key after you have typed the first If command. Sometimes the software will automatically add the EndIf command.
...
6.  We want to exclude the dimmer so now you can tap the Dimmer button in the [Preset Control Bar](../Workspace/Preset%20Control%20Bar.md).
...
← [Use filters when you Store and use At](Use%20filters%20when%20you%20Store%20and%20use%20At.md) | [What are masks](What%20are%20masks.md) →
