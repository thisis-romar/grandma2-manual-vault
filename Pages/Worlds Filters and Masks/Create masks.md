...
prev_page: "[Pages/Worlds Filters and Masks/What are masks](What%20are%20masks.md)"
next_page: "[Pages/Worlds Filters and Masks/Use masks in the sheets and windows](Use%20masks%20in%20the%20sheets%20and%20windows.md)"
depth: 2
tags:
  - "type/page"
  - "section/wfm"
...
> [!source]- Source
> [MA Lighting Help – Create masks](https://help.malighting.com/grandMA2/en/help/key_wfm_create_mask.html)
...
If you do not know about the mask pool then please read the [What are masks topic](What%20are%20masks.md).

Press the Edit key followed by one of the Mask Pool objects to open the Mask Editor:

![](../../img/popup_edit-mask_v3-3.png)
...
![](../../img/popup_edit-mask_rules_v3-3.png)
...
![](../../img/popup_select-object_v3-3.png)
...
![](../../img/popup_select-vitual-fixture-types_v3-3.png)
...
This will display the fixtures that have the "No Parameter" option in the [EditSetup](../Patching/Adding%20fixtures%20to%20the%20show.md). This can be useful when you have fixtures that are only controlled by the MA VPU (=video processing unit) through the console, and you want to see what they do.
...
![](../../img/popup_select-rdm-display-mask_v3-3.png)
...
Gives you a new button in the fourth column called "Define Mask". This will open a pop-up where you can selected one or more of the attributes in the show. The pop-up is just like the attribute part of the Edit Filter pop-up. Read more about this in the [Create filters Topic](Create%20filters.md).

## The Lower part

The lover part changes a little depending on how you get the mask editor. The different ways to get to the editor is discussed in the [Use masks in sheets topic](Use%20masks%20in%20the%20sheets%20and%20windows.md).

There are four buttons that are almost always visible:

![](../../img/popup_edit-mask_lower-buttons_v3-3.png)
...
![](../../img/popup_select-mask_v3-3.png)
...
Please read the [Use Masks in Sheets topic](Use%20masks%20in%20the%20sheets%20and%20windows.md) to learn more about how it use the masks in the different sheets and windows.

← [What are masks](What%20are%20masks.md) | [Use masks in the sheets and windows](Use%20masks%20in%20the%20sheets%20and%20windows.md) →
