...
prev_page: "[Pages/Worlds Filters and Masks/Use masks in the sheets and windows](Use%20masks%20in%20the%20sheets%20and%20windows.md)"
depth: 2
tags:
  - "type/page"
  - "section/wfm"
...
> [!source]- Source
> [MA Lighting Help – Apply worlds or filters to executors and sequences](https://help.malighting.com/grandMA2/en/help/key_wfm_apply_to_exec_seq.html)
...
If you have come to this page without knowing about worlds and filters, then you should read the [What are Worlds topic](What%20are%20Worlds.md) and [What are Filters topic](What%20are%20filters.md).
...
![](../../img/menu_assign_options_v3-2.png)
...
![](../../img/popup_select-playback-filter_v3-3.png)
...
Read more in the [Sequence mini executor topic](../Command%20Syntax%20and%20Keywords/Sequence%20mini%20executor.md).

← [Use masks in the sheets and windows](Use%20masks%20in%20the%20sheets%20and%20windows.md)
