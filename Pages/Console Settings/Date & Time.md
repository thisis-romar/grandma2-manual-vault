...
prev_page: "[Pages/Console Settings/Wing & Monitor Setup](Wing%20&%20Monitor%20Setup.md)"
depth: 2
tags:
  - "type/page"
  - "section/date"
...
> [!source]- Source
> [MA Lighting Help – Date & Time](https://help.malighting.com/grandMA2/en/help/key_date_time.html)

Version 3.9

# Date & Time

Sometimes the console needs to know the current date and time, and sometimes also the location of the console. These settings are important if an **Agenda** is used. For more information, read the **[Agenda](../../Sections/Agenda.md)** topic. 

The date and time settings are located in the **Setup I Console I Date & Time**.

![](../../img/window_time_date_v3_3.png)
...
![](../../img/popup_daylight_info_v3_3.png)
...
← [Wing & Monitor Setup](Wing%20&%20Monitor%20Setup.md)
