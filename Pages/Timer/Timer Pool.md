...
cssclasses:
  - "gma2-page"
title_str: "Timer Pool"
slug: "key_timers_timer_pool"
url: "https://help.malighting.com/grandMA2/en/help/key_timers_timer_pool.html"
section: "Timer"
ma2_section: "key_timer"
section_ref: "[Sections/Timer](../../Sections/Timer.md)"
next_page: "[Pages/Timer/Timer Pool Options](Timer%20Pool%20Options.md)"
depth: 2
tags:
  - "type/page"
  - "section/timers"
...
> [!source]- Source
> [MA Lighting Help – Timer Pool](https://help.malighting.com/grandMA2/en/help/key_timers_timer_pool.html)
...
1.  Open the timer pool:  
    \-Tap Pools in **Create Basic Window**. For more information on how to open a basic window see [Manage windows](../../Sections/Windows.md).  
...
4.  Set the time unit:  
    ...
    ![](../../img/popup_select-time-unit_timer-pool_v3-3.png)
...
6.  To set a link to an executor, tap **Exec Trigger**.  
    ...
    ![](../../img/popup_exec-trigger_timer-pool_v3-3.png)
...
10.  Now, select the type of the alert:  
     ...
     ![](../../img/popup_select-alter-type_timer-pool_v3-3.png)
...
**Hint:**  
You can play back a stopwatch or a countdown saved in the timer pool in the Clock. For more information see [Other System Tools - Clock](../Other%20System%20Tools/Clock.md).

[Timer Pool Options](Timer%20Pool%20Options.md) →

Part of [Timer](../../Sections/Timer.md) · [000 Map of Content](../../000%20Map%20of%20Content.md)
