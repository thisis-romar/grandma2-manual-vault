...
prev_page: "[Pages/Patching/Stage View](Stage%20View.md)"
next_page: "[Pages/Patching/Position fixtures in the virtual 3D stage](Position%20fixtures%20in%20the%20virtual%203D%20stage.md)"
depth: 2
tags:
  - "type/page"
  - "section/patch"
...
The cameras are located in the Camera Pool. You can create a camera pool on your screens using the **Create Basic Window** pop-up. It is described in the [Manages windows topic](../../Sections/Windows.md).
...
You will need to add this camera controller fixture to your fixture setup - read about it in the [Adding fixtures to your show topic](Adding%20fixtures%20to%20the%20show.md). When you have the fixture then you can link the camera with the controller fixture.
...
← [Stage View](Stage%20View.md) | [Position fixtures in the virtual 3D stage](Position%20fixtures%20in%20the%20virtual%203D%20stage.md) →
