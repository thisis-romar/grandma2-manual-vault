...
cssclasses:
  - "gma2-page"
title_str: "Delete fixtures from the show"
...
prev_page: "[Pages/Patching/Adding fixtures to the show](Adding%20fixtures%20to%20the%20show.md)"
next_page: "[Pages/Patching/Working with Layers](Working%20with%20Layers.md)"
depth: 2
tags:
  - "type/page"
  - "section/patch"
...
> [!source]- Source
> [MA Lighting Help – Delete fixtures from the show](https://help.malighting.com/grandMA2/en/help/key_patch_delete_fixtures.html)
...
**Important:**  
For details about Layers please read the [Working with Layers](Working%20with%20Layers.md) topic.  
For details about the **EditSetup** menu please read the [Adding fixtures to your show](Adding%20fixtures%20to%20the%20show.md) topic.
...
![](../../img/popup_attention_delete-object_v3-2.png)
...
Read more details about the Warning pop-up at the end of the [Adding fixtures to the show](Adding%20fixtures%20to%20the%20show.md) topic.
...
← [Adding fixtures to the show](Adding%20fixtures%20to%20the%20show.md) | [Working with Layers](Working%20with%20Layers.md) →
