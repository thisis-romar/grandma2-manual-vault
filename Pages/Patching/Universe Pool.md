...
You can create a Universe pool on your screens using the **Create Basic Window** pop-up. It is described in the [Manages windows topic](key_windows.html).
...
Many off the options related to the DMX universe is explained in the [DMX List part of the DMX and Parameter lists topic](key_patch_dmx_parameter_list.html#dmx_list).
...
*   **DMX In Merge:**  
    ...
    This is explained in more details the [DMX List](key_patch_dmx_parameter_list.html#dmx_list).
*   **RDM:**  
    ...
    For more details about this please read the [Turn RDM on per universe part of Turn RDM on topic](key_rdm_turn_on.html#rdm_on_universe).
*   **RDM Devices:**  
    Here you can see the amount of RDM fixtures found in the universe.  
    For more details about the RDM feature please read the [RDM section](key_rdm.html).
*   **Requested:**  
...
*   **Parked:**  
    ...
    Read more about the park function in the [Park Keyword topic](key_keyword_park.html).
*   **DMX Tester:**  
