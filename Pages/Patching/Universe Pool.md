...
prev_page: "[Pages/Patching/DMX and Parameter lists](DMX%20and%20Parameter%20lists.md)"
next_page: "[Pages/Patching/Stage View](Stage%20View.md)"
depth: 2
tags:
  - "type/page"
  - "section/patch"
...
> [!source]- Source
> [MA Lighting Help – Universe Pool](https://help.malighting.com/grandMA2/en/help/key_patch_universe_pool.html)
...
You can create a Universe pool on your screens using the **Create Basic Window** pop-up. It is described in the [Manages windows topic](../../Sections/Windows.md).

It is a pool. To learn general thing about the pools please read the [Pools in General section](../../Sections/Pools.md).

Each universe with something patched is displayed as a pool object.

The Universe pool could look like this (Pool Mode):

![](../../img/window_universe-pool_v3-3.png)
...
![](../../img/window_universe-pool_sheet_v3-3.png)
...
Many off the options related to the DMX universe is explained in the [DMX List part of the DMX and Parameter lists topic](DMX%20and%20Parameter%20lists.md).
...
*   **DMX In Merge:**  
    ...
    This is explained in more details the [DMX List](DMX%20and%20Parameter%20lists.md).
*   **RDM:**  
    ...
    For more details about this please read the [Turn RDM on per universe part of Turn RDM on topic](../RDM/Turn%20RDM%20on.md).
*   **RDM Devices:**  
    Here you can see the amount of RDM fixtures found in the universe.  
    For more details about the RDM feature please read the [RDM section](../../Sections/RDM.md).
*   **Requested:**  
...
*   **Granted:**  
    ...
    This is explained in more details the [DMX List](DMX%20and%20Parameter%20lists.md).
*   **Info:**  
    This is where you can see or edit the information attached to the universe. If there is any information attached to the universe then there is the ![](../../img/icon_information_v3-2.png) icon in the pool button.
*   **Sync:**  
...
*   **Parked:**  
    ...
    Read more about the park function in the [Park Keyword topic](../../Keywords/Park.md).
*   **DMX Tester:**  
    ...
    Read more details about the DMX tester function in the [DMX testing topic](DMX%20testing%20in%20the%20DMX%20Sheet.md).

← [DMX and Parameter lists](DMX%20and%20Parameter%20lists.md) | [Stage View](Stage%20View.md) →
