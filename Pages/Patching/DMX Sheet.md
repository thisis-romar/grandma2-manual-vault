...
prev_page: "[Pages/Patching/Live patching](Live%20patching.md)"
next_page: "[Pages/Patching/DMX testing in the DMX Sheet](DMX%20testing%20in%20the%20DMX%20Sheet.md)"
depth: 2
tags:
  - "type/page"
  - "section/patch"
...
> [!source]- Source
> [MA Lighting Help – DMX Sheet](https://help.malighting.com/grandMA2/en/help/key_patch_dmx_sheet.html)
...
Fixtures can be selected using a DMX address by pressing the Select key twice and then the DMX address in the sheet - Have a look at the [DMX keyword](../../Keywords/Dmx%20keyword.md).

The Assign key can be used in combination with the sheet to patch fixtures - please have a look at the [Live patching](Live%20patching.md) topic.
...
![](../../img/window_dmx_detail_v3-2.png)

_DMX Sheet detail_

If a DMX channel is parked then there is a blue square in the cell.

If there is a white or yellow square then the DMX address is under influence of the [DMX Tester](DMX%20testing%20in%20the%20DMX%20Sheet.md).
...
The options are all described in the [Sheet Options topics](../Operate%20Fixtures/Sheet%20options.md).

← [Live patching](Live%20patching.md) | [DMX testing in the DMX Sheet](DMX%20testing%20in%20the%20DMX%20Sheet.md) →
