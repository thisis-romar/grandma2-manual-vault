...
prev_page: "[Pages/Patching/Universe Pool](Universe%20Pool.md)"
next_page: "[Pages/Patching/Virtual 3D Cameras](Virtual%203D%20Cameras.md)"
depth: 2
tags:
  - "type/page"
  - "section/patch"
...
> [!source]- Source
> [MA Lighting Help – Stage View](https://help.malighting.com/grandMA2/en/help/key_patch_stage.html)
...
It is a view you can create using the [Create Basic Window](../../Sections/Windows.md) pop-up.

It could look like this:

![](../../img/window_stage_v3-3.png)
...
New fixtures are positioned at the 0,0,0 XYZ location. You can move your fixtures position to match your real world positions. To learn more about positioning the fixtures please read the [Position fixtures in the 3D stage](Position%20fixtures%20in%20the%20virtual%203D%20stage.md) topic.

## Moving around in the Stage View

You can freely move around in the virtual 3D space. What you are moving is actually a virtual camera. The cameras are described in more details in the [Virtual 3D Cameras topic](Virtual%203D%20Cameras.md).
...
Remember that you are moving a camera. There are several default cameras that you select. The stage view can show you the stage from a specific camera or from the camera that you have selected in the [Camera Pool](Virtual%203D%20Cameras.md).
...
![](../../img/window_stage_camera-button_v3-2.png)
...
The first one is called **Calibration**. This has one button. Tapping this will open the auto-calibration of moving light position. This has its own topic - please read about it here [Autocalibrate fixture positions](Auto-calibrate%20fixture%20positions.md).
...
Next tap is the **Mask** function. Here you can set up a mask for the view. You can create a mask that hides fixtures based on a set of four rules. Read more about masks in the [What are masks topic](../Worlds%20Filters%20and%20Masks/What%20are%20masks.md).
...
*   **Prog Only, Active Only, Parked, Seq+, Seq-, Only Selected, Mask 7, Mask 8, Mask 9, Mask 10**:  
    These buttons are actually different mask buttons. The first six are the default mask. The last four are mask buttons that you can define. For more about the masks please read the [What are masks topic](../Worlds%20Filters%20and%20Masks/What%20are%20masks.md).
*   **Enable Mask**:  
    This button will enable or disable the mask function in the Stage view. For more about the masks please read the [What are masks topic](../Worlds%20Filters%20and%20Masks/What%20are%20masks.md).
*   **Follow Mask**:  
    This button will make the Stage view use the selected mask (In the Mask Pool). For more about the masks please read the [What are masks topic](../Worlds%20Filters%20and%20Masks/What%20are%20masks.md).
...
← [Universe Pool](Universe%20Pool.md) | [Virtual 3D Cameras](Virtual%203D%20Cameras.md) →
