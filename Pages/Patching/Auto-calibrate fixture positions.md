...
prev_page: "[Pages/Patching/Position fixtures in the virtual 3D stage](Position%20fixtures%20in%20the%20virtual%203D%20stage.md)"
depth: 2
tags:
  - "type/page"
  - "section/patch"
...
> [!source]- Source
> [MA Lighting Help – Auto-calibrate fixture positions](https://help.malighting.com/grandMA2/en/help/key_patch_autocalibrate.html)
...
You can access this system using a [Stage View](Stage%20View.md) and opening the **Stage View Options**. Here is a tab called "Calibration". In this tab you will find a single button called Calibrate Fixture Pos. Tapping this will open the Calibration pop-up.

It could look like this:

![](../../img/popup_calibration_absolute_v3-4.png)
...
When the **Output Stage Values** button is active, then the currently selected fixtures will output the Stage values. Stage values can be edited in the [Parameter List](DMX%20and%20Parameter%20lists.md), Fixture Types editor and in the Fixture editor.
...
![](../../img/popup_calibration_free_v3-3.png)
...
3.  Setup the approximate XYZ positions for your fixtures. If you do not know how then you can read about it in the [Position fixtures in the 3D stage topic](Position%20fixtures%20in%20the%20virtual%203D%20stage.md).
...
← [Position fixtures in the virtual 3D stage](Position%20fixtures%20in%20the%20virtual%203D%20stage.md)
