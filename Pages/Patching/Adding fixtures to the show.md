...
prev_page: "[Pages/Patching/What is 3D and Stage setup](What%20is%203D%20and%20Stage%20setup.md)"
next_page: "[Pages/Patching/Delete fixtures from the show](Delete%20fixtures%20from%20the%20show.md)"
depth: 2
tags:
  - "type/page"
  - "section/patch"
...
> [!source]- Source
> [MA Lighting Help – Adding fixtures to the show](https://help.malighting.com/grandMA2/en/help/key_patch_add_fixtures.html)
...
Read more details about Layers in the [Working with Layers topic](Working%20with%20Layers.md).
...
![](../../img/popup_fixture_wizard_v3-3.png)
...
![](../../img/popup_import-fixture-type_v3-3.png)
...
For the grandMA2 to be able to see the fixture types they need to be in the correct folder. If you insert a USB stick and open the [Backup menu,](../../Sections/Backup%20Menu.md) then it automatically create the folder structure needed.

Fixture types need to be in the folder called "library". This folder need to be inside a folder called "gma2".

![](../../img/img_usb-file-structure_library_v3_2.png)
...
You can choose the display information about the DMX channels below the list. If you tap the ![](../../img/icon_info_v3-2.png) in the title bar then you will see the list of DMX channels and what function they have.
...
Depending on what fixture type you have selected, you might have up to 8 different [Patch Breaks](What%20are%20DMX%20breaks.md). Most fixture only need one, but some multi instance fixtures needs several DMX start addresses.
...
![](../../img/popup_select-fixture-type_v3-2.png)
...
![](../../img/popup__color-transform-options_v3-3.png)
...
![](../../img/popup_select-color_v3-2.png)
...
This the XYZ position of the fixture in the 3D space. Read more about positioning fixtures in the [Position fixtures in the 3D stage topic](Position%20fixtures%20in%20the%20virtual%203D%20stage.md).

**Rot X, Rot Y, Rot Z:**

This the XYZ rotation of the fixture in the 3D space. Read more about positioning fixtures in the [Position fixtures in the 3D stage topic](Position%20fixtures%20in%20the%20virtual%203D%20stage.md).
...
This will display the RDM ID of the fixture when it matched in the [RDM Devices](../RDM/Match%20RDM%20devices.md).
...
![](../../img/img_encoder-toolbar_dmx-patch_v3-3.png)
...
![](../../img/menu_editsetup-warning_v3-2.png)
...
[Fixture types](../../Sections/Basic%20Fixture%20Types.md)

[Fixture position](Position%20fixtures%20in%20the%20virtual%203D%20stage.md)

[DMX profiles](../../Sections/DMX%20Profiles.md)

[DMX List](DMX%20and%20Parameter%20lists.md)

[Live patching](Live%20patching.md)

[Multipatch](Multipatching.md)

[Export/Import](../../Sections/Export%20and%20Import.md)

[Layers](Working%20with%20Layers.md)

[RDM devices](../../Sections/RDM.md)

← [What is 3D and Stage setup](What%20is%203D%20and%20Stage%20setup.md) | [Delete fixtures from the show](Delete%20fixtures%20from%20the%20show.md) →
