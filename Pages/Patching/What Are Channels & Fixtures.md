...
next_page: "[Pages/Patching/What is 3D and Stage setup](What%20is%203D%20and%20Stage%20setup.md)"
depth: 2
tags:
  - "type/page"
  - "section/patch"
...
> [!source]- Source
> [MA Lighting Help – What Are Channels & Fixtures](https://help.malighting.com/grandMA2/en/help/key_patch_what_are_channel_fixture.html)
...
When talking (or writing) about the actual device that emits light, we are referring to that as a fixture. This might be all sorts of devices from different manufacturers. They may have one function or many different functions. All these functions are called [Attributes](What%20are%20Attributes.md).
...
*   [Attributes](What%20are%20Attributes.md)
*   [DMX break](What%20are%20DMX%20breaks.md)

[What is 3D and Stage setup](What%20is%203D%20and%20Stage%20setup.md) →
