...
Both of these are linked and display the information stored in the show file. It only makes sense to use these if you take the time to [arrange your virtual fixtures according to the real world locations](key_patch_position_fixtures.html).

In the grandMA2 software you can see a very simplified version of the 3D space. This can be seen in the [Stage Window](key_patch_stage.html).
