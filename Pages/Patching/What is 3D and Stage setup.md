...
prev_page: "[Pages/Patching/What Are Channels & Fixtures](What%20Are%20Channels%20&%20Fixtures.md)"
next_page: "[Pages/Patching/Adding fixtures to the show](Adding%20fixtures%20to%20the%20show.md)"
depth: 2
tags:
  - "type/page"
  - "section/patch"
...
> [!source]- Source
> [MA Lighting Help – What is 3D and Stage setup](https://help.malighting.com/grandMA2/en/help/key_patch_what_is_3d_stage.html)
...
Both of these are linked and display the information stored in the show file. It only makes sense to use these if you take the time to [arrange your virtual fixtures according to the real world locations](Position%20fixtures%20in%20the%20virtual%203D%20stage.md).

In the grandMA2 software you can see a very simplified version of the 3D space. This can be seen in the [Stage Window](Stage%20View.md).
...
← [What Are Channels & Fixtures](What%20Are%20Channels%20&%20Fixtures.md) | [Adding fixtures to the show](Adding%20fixtures%20to%20the%20show.md) →
