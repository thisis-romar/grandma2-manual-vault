...
prev_page: "[Pages/Patching/Working with Layers](Working%20with%20Layers.md)"
next_page: "[Pages/Patching/Live patching](Live%20patching.md)"
depth: 2
tags:
  - "type/page"
  - "section/patch"
...
> [!source]- Source
> [MA Lighting Help – Multipatching](https://help.malighting.com/grandMA2/en/help/key_patch_multipatch.html)
...
The second GUI process involves live patching and the DMX sheet. [Read about it here](Live%20patching.md).
...
For more about positioning the fixture in MA 3D or the Stage view, please have look at the [Position fixtures in the 3D stage](Position%20fixtures%20in%20the%20virtual%203D%20stage.md) topic.

← [Working with Layers](Working%20with%20Layers.md) | [Live patching](Live%20patching.md) →
