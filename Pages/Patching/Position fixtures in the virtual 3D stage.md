...
prev_page: "[Pages/Patching/Virtual 3D Cameras](Virtual%203D%20Cameras.md)"
next_page: "[Pages/Patching/Auto-calibrate fixture positions](Auto-calibrate%20fixture%20positions.md)"
depth: 2
tags:
  - "type/page"
  - "section/patch"
...
> [!source]- Source
> [MA Lighting Help – Position fixtures in the virtual 3D stage](https://help.malighting.com/grandMA2/en/help/key_patch_position_fixtures.html)

Version 3.9

# Position fixtures in the virtual 3D stage

To fully enjoy the [Stage view](Stage%20View.md) you will need to position your fixtures in the virtual 3D stage.
...
![](../../img/img_encoder-toolbar_stage-setup_1_v3_3.png)
...
![](../../img/img_encoder-toolbar_stage-setup_2_v3_3.png)
...
![](../../img/popup_arrangement-wizard_move_v3-3.png)
...
![](../../img/popup_arrangement-wizard_circle_v3-3.png)
...
![](../../img/popup_arrangement-wizard_matrix2d_v3-3.png)
...
You can also position and rotate the fixtures in the [EditSetup](Adding%20fixtures%20to%20the%20show.md) or [LiveSetup](Live%20patching.md).
...
![](../../img/popup_fixture-positions_v3-3.png)

_Fixture Positions pop-up_

The top half works a lot like the [Stage View](Stage%20View.md). Although there is an extra swipe button in the title bar.
...
![](../../img/popup_select-model_v3-3.png)
...
← [Virtual 3D Cameras](Virtual%203D%20Cameras.md) | [Auto-calibrate fixture positions](Auto-calibrate%20fixture%20positions.md) →
