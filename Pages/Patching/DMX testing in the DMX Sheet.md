...
prev_page: "[Pages/Patching/DMX Sheet](DMX%20Sheet.md)"
next_page: "[Pages/Patching/DMX and Parameter lists](DMX%20and%20Parameter%20lists.md)"
depth: 2
tags:
  - "type/page"
  - "section/patch"
...
You'll need to open a [DMX sheet](DMX%20Sheet.md) and make sure the "Link Encoders" option is activated.
...
The right most encoder is used to patch a fixture to the selected DMX address. To learn more about this and live patching please [follow this link](Live%20patching.md).
...
This can be used to park the currently selected DMX address at the current DMX value. Read more about the park function in the [Park Keyword](../../Keywords/Park.md).

**Unpark Current:**

This can be used to unpark the currently selected DMX address. Read more about the unpark function in the [Unpark Keyword](../../Keywords/Unpark.md).

## Using the DMX tester with the command line

You can also do some DMX testing from the command line.

To do this you need to use the [DMX keyword](../../Keywords/Dmx%20keyword.md).
...
← [DMX Sheet](DMX%20Sheet.md) | [DMX and Parameter lists](DMX%20and%20Parameter%20lists.md) →
