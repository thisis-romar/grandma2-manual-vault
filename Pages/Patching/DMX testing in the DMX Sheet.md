...
You'll need to open a [[Pages/Patching/DMX Sheet|DMX sheet]] and make sure the "Link Encoders" option is activated.
...
The right most encoder is used to patch a fixture to the selected DMX address. To learn more about this and live patching please [[Pages/Patching/Live patching|follow this link]].
...
This can be used to park the currently selected DMX address at the current DMX value. Read more about the park function in the [[Keywords/Park|Park Keyword]].

**Unpark Current:**

This can be used to unpark the currently selected DMX address. Read more about the unpark function in the [[Keywords/Unpark|Unpark Keyword]].

## Using the DMX tester with the command line

You can also do some DMX testing from the command line.

To do this you need to use the [[Keywords/Dmx keyword|DMX keyword]].
