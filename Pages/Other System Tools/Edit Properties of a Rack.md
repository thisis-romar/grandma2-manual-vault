...
cssclasses:
  - "gma2-page"
title_str: "Edit Properties of a Rack"
...
prev_page: "[Pages/Other System Tools/Readout](Readout.md)"
next_page: "[Pages/Other System Tools/Edit a Module](Edit%20a%20Module.md)"
depth: 3
tags:
  - "type/page"
  - "section/ost"
summary: "You can edit the properties of racks."
---

# Edit Properties of a Rack

> [!source]- Source
> [MA Lighting Help – Edit Properties of a Rack](https://help.malighting.com/grandMA2/en/help/key_ost_edit_properties_of_rack.html)
...
For more information see [Adding devices to your session](../Networking/Adding%20devices%20to%20the%20session.md). 

*   Open **MA Dimmer Network**

For more information on how to open the **MA Dimmer Network** see [Network dimmer](Network%20Dimmer.md). 

1.  To edit the properties of a rack, press Edit and tap a rack. The window **Rack Properties** opens.
    

![](../../img/popup_rack-properties_network-dimmer_v3-3.png)
...
2.  To edit the merge mode, tap the button displayed below Merge Mode.  
    ...
    ![](../../img/popup_select-slot-mode_network-dimmer_v3-3.png)
...
3.  To edit a slot, tap the button displayed below Data Slot 1 and Data Slot 2.  
    ...
    ![](../../img/popup_slot-properties_network-dimmer_v3-3.png)
    ...
    \-To enter a patch address, type into the green input field or tap the ![](../../img/icon_plus_small_v3-2.png) and the calculator opens.
4.  Now, tap Please.
...
5.  To edit universes, tap the button displayed below Input Config.  
    ...
    ![](../../img/popup_input-properties_network-dimmer_v3-3.png)
    
    _Edit universes_
    
      
    \-To edit the universes in Line 1 and Line 2, tap the ![](../../img/icon_minus_v3-2.png) or ![](../../img/icon_plus_v3-2.png) or type in the green input field using the keyboard.  
    ...
    ![](../../img/popup_artnet-input-properties_network-dimmer_v3-3.png)
    
    _Adjust the input properties of Art-Net_ 
...
6.  After you have edited the properties of the rack, save the settings.  
    ...
    ![](../../img/popup_save-rack-configuration_network-dimmer_v3-3.png)
    ...
    \-To cancel the process, tap Cancel or ![](../../img/icon_close_small_v3-2.png) in the upper right corner of the pop-up.
...
8.  To select the next or the previous rack, tap ![](../../img/icon_previous_v3-3.png) or ![](../../img/icon_next_v3-3.png). 
9.  To create a rack, tap New and the **pop-up Select Rack Number** opens.
    
    ![](../../img/popup_select-rack-number_network-dimmer_v3-3.png)
...
10.  To load an existing rack, tap Load and the **pop-up Load Rack Configuration opens**.
     ...
     ![](../../img/popup_load-rack-configuration_network-dimmer_v3-3.png)
...
← [Readout](Readout.md) | [Edit a Module](Edit%20a%20Module.md) →
