...
next_page: "[Pages/Other System Tools/Errors](Errors.md)"
depth: 3
tags:
  - "type/page"
  - "section/ost"
...
For more information on the dimMA hierarchy see [Network dimmer](Network%20Dimmer.md). 
...
**Hint:**  
The following settings can also be edited in a module. For more information see [Edit a module](Edit%20a%20Module.md). 
...
**Hint:**  
The general settings of profiles are similar to those in the graph editor of an effect. For more information on these settings see [Settings in the Graph Editor in Create effect forms](../Effects/Create%20Effect%20Forms.md). 
...
For more information on the display of errors see [Errors](Errors.md). 
