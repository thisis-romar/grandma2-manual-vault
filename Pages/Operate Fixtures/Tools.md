...
next_page: "[Pages/Operate Fixtures/Layer mask](Layer%20mask.md)"
depth: 3
tags:
  - "type/page"
  - "section/of"
...
The last part of the options described here, is also available as [Title Buttons](Title%20buttons.md).
...
Read more about it in the [Preset Control Bar subtopic](../Workspace/Preset%20Control%20Bar.md).
...
Read more about layers in the [Layers in the programmer topic](Channel%20Sheet%20and%20Fixture%20Sheet.md).
...
The Masks are described in the [Mask topics](../Worlds%20Filters%20and%20Masks/What%20are%20masks.md).
...
If this option is on then activating the sheet (by tapping inside the sheet) will change the [Encoder Toolbar](../Workspace/Encoder%20Toolbar.md). The result is different depending on the type of sheet.

### DMX Sheet

The Encoder Toolbar will turn into the DMX tester. Read more about it in the [DMX Testing topic](../Patching/DMX%20testing%20in%20the%20DMX%20Sheet.md).

### Content Sheet and Tracking Sheet

The Encoder Toolbar will turn into the Executor Toolbar. Read more about it in the [What are executors topic](../Executors/What%20are%20executors.md).

### Executor Sheet

It is bit hidden as an option for the Executor Sheet. You need to add it as a [title button](Title%20buttons.md) to enable or disable it.
...
With this option **on**, any changes made to values in the sheet are stored as Cue Only. Read more about editing values in the two sheets in the [Looking at your cue content topic](../Command%20Syntax%20and%20Keywords/Looking%20at%20the%20cue%20content.md).
