...
prev_page: "[Pages/Operate Fixtures/Layer mask](Layer%20mask.md)"
next_page: "[Pages/Operate Fixtures/Title buttons](Title%20buttons.md)"
depth: 3
tags:
  - "type/page"
  - "section/of"
...
> [!source]- Source
> [MA Lighting Help – Display](https://help.malighting.com/grandMA2/en/help/key_of_sheet_options_display.html)
...
![](../../img/popup_select-font_v3-3.png)
...
![](../../img/popup_select-readout_v3-3.png)
...
Readout can also be a [Title Button](Title%20buttons.md).

## Cue Color Columns

**Cue Color Columns** is an option in Executor and Tracking sheets.

The [Appearance keyword](../../Keywords/Appearance%20keyword.md) can be used to give a color to individual cues. This option changes how this color is displayed in the sheets.
...
![](../../img/popup_select-cue-color-columns_v3-3.png)
...
![](../../img/popup_select-symbol-output_v3-3.png)
...
For more information about the different layers please read the [Layers in sheets topic](Layer%20in%20Sheets.md).
...
![](../../img/popup_select-cue-color_v3-3.png)
...
*   **On**  
    The attribute values from the primary selected executor displays the colors Cyan, Green, White, and Magenta. These colors are described in detail in the [Cue Colors Topic](../Workspace/Cue%20Colors.md). Values from other executors are displayed in yellow.
*   **My Exec**  
...
Autoscroll can also be a [Title Button](Title%20buttons.md).
...
Feature Sort can also be a [Title Button](Title%20buttons.md).
...
Fixture Sort or Channel Sort can also be a [Title Button](Title%20buttons.md).
...
Read more about the markers in the [Maker Colors topic](../Workspace/Marker%20Colors.md).
...
![](../../img/popup_select-preset-readout_v3-3.png)
...
Hide Timing Countdown can also be a [Title Button](Title%20buttons.md).
...
![](../../img/popup_select-show-additional_v3-3.png)
...
*   **Show only Values:**  
    ...
    ![](../../img/window_dmx_additional-none_v3-2.png)
...
*   **Show IDs:**  
    ...
    ![](../../img/window_dmx_additional-id_v3-2.png)
...
*   **Show Attributes:**  
    ...
    ![](../../img/window_dmx_additional-attribute_v3-2.png)
...
*   **Show Address:**  
    ...
    ![](../../img/window_dmx_additional-address_v3-2.png)
    
    _DMX values with DMX addresses above each value_
    

Show Additional can also be a [Title Button](Title%20buttons.md).
...
Show Only Selected can also be a [Title Button](Title%20buttons.md).
...
Programmer Colors can also be a [Title Button](Title%20buttons.md).
...
![](../../img/popup_select-mixcolor-readout_v3-3.png)
...
*   **Default:**  
    The MixColors are displayed using the default selected in the setup - Read more about setting this in the [User Settings topic](../Single%20and%20Multi%20User%20Systems/User%20specific%20settings.md).

MixColor Readout can also be a [Title Button](Title%20buttons.md).
...
![](../../img/popup_select-rdm-info_v3-3.png)
...
Read more about RDM and how to configure the warning and alert notifications in the [RDM section](../../Sections/RDM.md).

← [Layer mask](Layer%20mask.md) | [Title buttons](Title%20buttons.md) →
