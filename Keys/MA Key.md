...
tags:
  - "type/key"
summary: "The !ma key is located in the command area below the 0."
---

# MA Key

> [!source]- Source
> [MA Lighting Help – MA Key](https://help.malighting.com/grandMA2/en/help/key_key_ma.html)

Version 3.9

# MA Key

The ![ma](../../img/ma_1.png) key is located in the command area below the 0.

![](../../img/img_ma-key_v3-2.png)
...
![ma](../../img/ma_1.png) + number

No command

Selects the preset type in the preset control bar indicated by the preset type number.

![ma](../../img/ma_1.png) + number + same number again

No command

Toggles through the features of a preset type in the preset type bar.
...
![ma](../../img/ma_1.png) + Down

No command

Moves down the monitor wing.
...
Releases the monitor wing brake to adjust the angle of the monitor manually.
...
![ma](../../img/ma_1.png) + Time

No command

Opens the effect layer in the encoder bar.

![ma](../../img/ma_1.png) + Time + Time
...
Moves up the monitor wing.

![ma](../../img/ma_1.png) + Update

No command

Lists updates in the command line feedback view. 
...
![ma](../../img/ma_1.png) + V key

No command

Selects the view page indicated by the V key number.
