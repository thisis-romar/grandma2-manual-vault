...
For more information on how to use filters see [What are filters](../Pages/Worlds%20Filters%20and%20Masks/What%20are%20filters.md).
...
**Hint:**  
​-It is also possible to use the Circular Copy in the MAtricks toolbar. For more information see [MAtricks toolbar - Circular Copy](../Pages/MAtricks/MAtricks%20Toolbar.md)​.  
​-To access the Circular Copy in a window, press Tools. For more Information see the [Tools key](../Keys/Tools%20Key.md).
