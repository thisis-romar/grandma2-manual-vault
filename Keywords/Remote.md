...
For more information, see [What are Remote Inputs?](../Pages/Remote%20Control/Remote%20Inputs.md) and Set up Remote Inputs.
...
The following table displays the assignable parameter via the command line, using the [Assign keyword](Assign%20keyword.md).
