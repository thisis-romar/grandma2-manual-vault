...
tags:
  - "type/keyword"
summary: "PSRPrepare prepares a showfile for PartialShowRead."
---

# PSRPrepare

> [!source]- Source
> [MA Lighting Help – PSRPrepare](https://help.malighting.com/grandMA2/en/help/key_keyword_psrprepare.html)
...
For more information, see [Partial Show Read (PSR)](../Sections/Partial%20Show%20Read.md).
...
Uses the current setup.

mergeother

mo

Merges with the new setup.

useother

uo

Overwrites the current setup and uses the new setup.
