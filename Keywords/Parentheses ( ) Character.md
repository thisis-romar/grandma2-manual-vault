...
> [!source]- Source
> [MA Lighting Help – Parentheses ( ) Character](https://help.malighting.com/grandMA2/en/help/key_keyword_parentheses.html)
...
With the ( ) parentheses you create pop-up dialog in macros, to get user input. The user will be prompted with the text inside the round brackets, and a text input field. The macro line will be executed with the user input. For more information, see [create pop-ups in macros](../Pages/Macros/Create%20pop-ups%20in%20macros.md).
...
![](../../img/popup_macro-enter-cue-number_v3-2.png)
