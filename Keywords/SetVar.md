...
tags:
  - "type/keyword"
summary: "The SetVar keyword sets global show variables."
---
...
The SetVar keyword sets global show variables. Every user profile can use these variables. For more information, see [Macros - Use Variables](../Pages/Macros/Use%20variables%20in%20macros.md).
...
**Hint:**  
To see the set variables in the command line feedback window, use the [ListVar keyword](ListVar.md).
