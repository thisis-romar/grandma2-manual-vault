...
cssclasses:
  - "gma2-keyword"
keyword: "Import"
slug: "key_keyword_import"
url: "https://help.malighting.com/grandMA2/en/help/key_keyword_import.html"
keyword_type: "unknown"
tags:
  - "type/keyword"
summary: "Import is a function keyword to bring data from external .xml and .xmlp libraries into the show file."
---

# Import

> [!source]- Source
> [MA Lighting Help – Import](https://help.malighting.com/grandMA2/en/help/key_keyword_import.html)
...
Suppresses the confirmation pop-up of the import.
...
Suppresses the feedback of the import in the command line feedback window.
...
Specifies the path for the to be imported file.
