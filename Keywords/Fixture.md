...
The default function for fixture objects is [[Keywords/SelFix|SelFix]]. This means that entering fixtures without any function specified selects the fixtures.
