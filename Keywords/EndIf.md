...
tags:
  - "type/keyword"
summary: "EndIf is a helping keyword to indicate the end of an If statement."
---
...
EndIf is a helping keyword to indicate the end of an If statement. For more information see [If keyword](If.md).
