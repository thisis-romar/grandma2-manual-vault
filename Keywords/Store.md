...
related_key: "[Keys/Store Key](../Keys/Store%20Key.md)"
tags:
  - "type/keyword"
...
> [!source]- Source
> [MA Lighting Help – Store](https://help.malighting.com/grandMA2/en/help/key_keyword_store.html)
...
Stores preset values with the default preset scope.
...
Stores preset with global values.
...
Merges the new values into the existing values. New values have a higher priority and will overwrite existing values. If no new value is given, the values of the existing cue stays.
...
Suppress stores confirmation pop-up.
...
Removes stored values in the cue and stores the new values.
...
Removes stored values for attributes with active programmer values.
...
Stores view with selected screen.
...
Stores preset with selective values.
...
Stores preset with universal values.
...
Sets the x coordinate in the layout view. For more information, see [Layouts](../Sections/Layouts.md).
...
Sets the y coordinate in the layout view. For more information, see [Layouts](../Sections/Layouts.md).

## Example

1\. Store cue 7 in the sequence of the selected executor. For more information, see [Store Cues](../Pages/Command%20Syntax%20and%20Keywords/Storing%20cues.md).

\[Channel\]> Store 7

2\. Store dimmer preset 3 with all attributes and keep the values active in the programmer. For more information, see [Store Presets](../Pages/Presets/Create%20Presets.md).
