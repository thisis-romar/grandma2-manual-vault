...
tags:
  - "type/keyword"
summary: "BlindEdit is a toggle function."
---

# BlindEdit keyword

> [!source]- Source
> [MA Lighting Help – BlindEdit keyword](https://help.malighting.com/grandMA2/en/help/key_keyword_blindedit.html)
...
To execute this keyword type **BlindEdit** or the shortcut **BlindE** into the command line. 

**Hint:**  
Pressing the button Blind for over two seconds takes over the command **BlindEdit** into the command line.
