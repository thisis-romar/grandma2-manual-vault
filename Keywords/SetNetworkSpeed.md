...
**Hint:**  
To double-check the link speed, use the [NetworkInfo keyword](NetworkInfo.md) or press Setup **I** **column Network I** **tap** MA Network Control **I column Link Speed.**
