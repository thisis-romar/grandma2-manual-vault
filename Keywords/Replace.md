...
tags:
  - "type/keyword"
summary: "The replace keyword replaces object and values."
---

# Replace

> [!source]- Source
> [MA Lighting Help – Replace](https://help.malighting.com/grandMA2/en/help/key_keyword_replace.html)
...
The replace keyword replaces object and values. For more information, see [search and replace](../Sections/Search%20and%20Replace.md).
