...
> [!source]- Source
> [MA Lighting Help – SetIP](https://help.malighting.com/grandMA2/en/help/key_keyword_setip.html)
...
**Hint:**  
Another way to change the IP address of the Ethernet-interfaces of the console or station is, press Setup I tap MA Network Configuration  I column **IP ETHERCON 1(ETH0)** or **IP ETHERCON 2 (ETH1)**. For more information see [Networking - Set the IP address in onPC](../Pages/Networking/Set%20the%20IP%20address%20in%20the%20onPC.md). 
...
Sets the subnet mask of the Ethernet adapter.
...
Enables DHCP for the Ethernet adapter.
...
Sets the default gateway for the Ethernet adapter.
...
Suppress the SetIP confirmation pop-up.
...
For more information on what DHCP is see the [Glossary](../Sections/Glossary.md). 

For more information on how to use DHCP see [Using DHCP in MA devices](../Pages/Networking/Using%20DHCP%20in%20MA%20devices.md).
