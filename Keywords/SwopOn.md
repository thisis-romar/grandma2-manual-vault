...
tags:
  - "type/keyword"
summary: "The SwopOn keyword temporary overrides the master level of executors to full and all other master levels to zero."
---
...
To protect an executor from the swop function, assign Swop Protect in the [Assign Menu](../Pages/Executors/Assign%20a%20function.md). 
...
For further information see keyword [Goto](Goto.md). 
