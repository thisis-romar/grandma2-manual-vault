...
tags:
  - "type/keyword"
summary: "The WebRemoteProgOnly keyword, selects in the web remote fixture sheet the option Prg Only (= Programmer Only)."
---
...
The WebRemoteProgOnly keyword, selects in the [web remote](../Pages/Remote%20Control/Web%20Remote.md) fixture sheet the option **Prg Only** (= Programmer Only).
