...
**Important:**  
Most edits and command line actions with the keyword FixtureType has to be done while in the Edit Setup mode. For more information, see [ChangeDest keyword](ChangeDest%20keyword.md).
