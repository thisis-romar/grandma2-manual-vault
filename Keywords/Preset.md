...
related_key: "[Keys/Preset Key](../Keys/Preset%20Key.md)"
tags:
  - "type/keyword"
...
If no fixtures or channels are selected in the programmer, the default function is **SelFix**. For more information, see [SelFix keyword](SelFix.md).  
If fixtures or channels are selected in the programmer, the default function is **At**. For more information, see [At keyword](At%20keyword.md).
...
Assign the special mode. For more information, see [What are special modes?](../Pages/Presets/What%20Are%20Special%20Modes-.md)

Info

"additional information"

Assign additional information. Assigned information are displayed in the [info window](../Pages/Workspace/Info.md).
