...
related_key: "[Keys/Update Key](../Keys/Update%20Key.md)"
tags:
  - "type/keyword"
...
1\. Update current cue of the selected executor, according to the update defaults. For more information, see [Update a Cue](../Pages/Command%20Syntax%20and%20Keywords/Update%20cues.md).
...
3\. Update color preset 2 with global values, keep them active in the programmer, and without confirmation pop-up. For more information, see [Update Presets](../Pages/Presets/Update%20Presets.md).
