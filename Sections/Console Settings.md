...
> [!source]- Source
> [MA Lighting Help – Console Settings](https://help.malighting.com/grandMA2/en/help/key_console_settings.html)

Version 3.9

# Console Settings

Use the console settings to adjust the console to the environment.

For more information on the various settings see the links below:
