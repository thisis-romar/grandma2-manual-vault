...
tags:
  - "type/section"
pages:
  - "[Pages/Backup Menu/Create a new show](../Pages/Backup%20Menu/Create%20a%20new%20show.md)"
  - "[Pages/Backup Menu/Loading a show](../Pages/Backup%20Menu/Loading%20a%20show.md)"
  - "[Pages/Backup Menu/Saving a show](../Pages/Backup%20Menu/Saving%20a%20show.md)"
  - "[Pages/Backup Menu/Saving a show with a new name](../Pages/Backup%20Menu/Saving%20a%20show%20with%20a%20new%20name.md)"
  - "[Pages/Backup Menu/Deleting a Show](../Pages/Backup%20Menu/Deleting%20a%20Show.md)"
  - "[Pages/Backup Menu/Using a USB stick](../Pages/Backup%20Menu/Using%20a%20USB%20stick.md)"
  - "[Pages/Backup Menu/Setting up a file server](../Pages/Backup%20Menu/Setting%20up%20a%20file%20server.md)"
  - "[Pages/Backup Menu/Partial Show Read](../Pages/Backup%20Menu/Partial%20Show%20Read.md)"
  - "[Pages/Backup Menu/ASCII Show Read](../Pages/Backup%20Menu/ASCII%20Show%20Read.md)"
  - "[Pages/Backup Menu/grandMA2 to grandMA3 Show File Converter](../Pages/Backup%20Menu/grandMA2%20to%20grandMA3%20Show%20File%20Converter.md)"
...
If a USB stick is connect to the console/onPC, then it will get its own tab. Select this tab will change the default storage drive to the USB stick. Read the [Using a USB stick](../Pages/Backup%20Menu/Using%20a%20USB%20stick.md) to learn more about specific USB stick handling. 

If a file server is added to the system, then this will also get its own tab. This tab can be selected to save or load shows using the storage space on the server. Read the [Setting up a file server](../Pages/Backup%20Menu/Setting%20up%20a%20file%20server.md) to learn more about server setup. 

The selected tab is then the selected "drive" and the location where shows will be saved. The selected drive can also be selected using the command line - it is a command called SelectDrive or just SD - read more about it [here](../Keywords/SelectDrive.md).  
...
Read [here](../Pages/Backup%20Menu/Setting%20up%20a%20file%20server.md) for more about setting up a File Server.
...
Read [here](../Pages/Backup%20Menu/Using%20a%20USB%20stick.md) for more info about USB sticks and what advice and restrictions there might be.
...
The server setup can be complicated, so it has it own help topic - please read about it [here](../Pages/Backup%20Menu/Setting%20up%20a%20file%20server.md). 
...
*   [New show](../Pages/Backup%20Menu/Create%20a%20new%20show.md)
*   [Load show](../Pages/Backup%20Menu/Loading%20a%20show.md)
*   [Save show](../Pages/Backup%20Menu/Saving%20a%20show.md)
*   [Save show as...](../Pages/Backup%20Menu/Saving%20a%20show%20with%20a%20new%20name.md)
*   [Delete shows](../Pages/Backup%20Menu/Deleting%20a%20Show.md)
*   [Using a USB stick](../Pages/Backup%20Menu/Using%20a%20USB%20stick.md)
*   [Setting up a file server](../Pages/Backup%20Menu/Setting%20up%20a%20file%20server.md)
*   [Partial show read](../Pages/Backup%20Menu/Partial%20Show%20Read.md)
*   [ASCII show read](../Pages/Backup%20Menu/ASCII%20Show%20Read.md)
*   [grandMA2 to grandMA3 show file converter](../Pages/Backup%20Menu/grandMA2%20to%20grandMA3%20Show%20File%20Converter.md)

## Pages in This Section

- [Create a new show](../Pages/Backup%20Menu/Create%20a%20new%20show.md)
- [Loading a show](../Pages/Backup%20Menu/Loading%20a%20show.md)
- [Saving a show](../Pages/Backup%20Menu/Saving%20a%20show.md)
- [Saving a show with a new name](../Pages/Backup%20Menu/Saving%20a%20show%20with%20a%20new%20name.md)
- [Deleting a Show](../Pages/Backup%20Menu/Deleting%20a%20Show.md)
- [Using a USB stick](../Pages/Backup%20Menu/Using%20a%20USB%20stick.md)
- [Setting up a file server](../Pages/Backup%20Menu/Setting%20up%20a%20file%20server.md)
- [Partial Show Read](../Pages/Backup%20Menu/Partial%20Show%20Read.md)
- [ASCII Show Read](../Pages/Backup%20Menu/ASCII%20Show%20Read.md)
