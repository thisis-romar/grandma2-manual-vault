...
> [!source]- Source
> [MA Lighting Help – Manage windows](https://help.malighting.com/grandMA2/en/help/key_windows.html)
...
Save settings to default or load settings that were previously saved from the default.
