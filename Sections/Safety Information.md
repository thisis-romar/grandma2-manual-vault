...
> [!source]- Source
> [MA Lighting Help – Safety Information](https://help.malighting.com/grandMA2/en/help/key_safety_information.html)

Version 3.9

# Safety Information

This device is conform to the following harmonized standards:
...
MA Lighting does not cover damages which can be the result of an inobservance of the safety instructions.
...
*   [Symbols used](key_safety_information_symbols_used.html)
*   [Intended use](key_safety_information_intended_use.html)
*   [Dangers caused by electric current](key_safety_information_dangers_caused_by_electric_cur.html)
*   [General safety instructions](key_safety_information_general_safety_instructions.html)
