...
tags:
  - "type/section"
pages:
  - "[Pages/Clone/Clone In User Interface](../Pages/Clone/Clone%20In%20User%20Interface.md)"
  - "[Pages/Clone/Examples](../Pages/Clone/Examples.md)"
  - "[Pages/Clone/Clone Presets](../Pages/Clone/Clone%20Presets.md)"
...
3.  To clone using the [keyword Clone](../Keywords/Clone%20keyword.md) or the [screen](../Pages/Clone/Clone%20In%20User%20Interface.md). 
...
**Important:**  
It is possible to limit the scope of cloning by using the [keyword If](../Keywords/If.md).
...
For more information on replace see [Search and Replace](Search%20and%20Replace.md). 
...
*   [Clone in user interface](../Pages/Clone/Clone%20In%20User%20Interface.md)
*   [Examples](../Pages/Clone/Examples.md)
*   [Clone presets](../Pages/Clone/Clone%20Presets.md)
