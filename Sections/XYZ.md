...
> [!source]- Source
> [MA Lighting Help – XYZ](https://help.malighting.com/grandMA2/en/help/key_xyz.html)
...
![](../../img/menu_xyz_fixture-types_v3-3.png)

_Enable XYZ_

6.  To save the changes in the **Patch & Fixture Schedule**, close the **dialog Fixture Types**:  
    \-Tap ![](../../img/icon_close_small_v3-2.png) in the upper right corner of the dialog.  
