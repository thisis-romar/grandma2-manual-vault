...
How to run or playback the recorded timecode shows is described in the [[Pages/Timecode/Playing Back a Timecode Show|Playing Back a Timecode Show topic]]. This topic also describes the timecode generator.

Finally there is a topic with a few ideas or thoughts about shows with multiple timecode shows - [[Pages/Timecode/Organize The Show with Multiple Timecode Shows|Organize Your Show with Multiple Timecode Shows]].
