...
*   **Debug Window**:  
    This opens a new window that shows the [System Monitor](../Pages/Other%20System%20Tools/System%20monitor.md) as a separate window (not a part of the onPC windows).
*   **Cascade Windows**:  
...
The **CmdWing Bar** option can be turned On or Off. It changes how the bottom of screen 2 looks. It can match the look of the consoles or it can change to match the physical controls on the MA onPC Command Wing. See more in the [Command Wing Bar topic](../Pages/Workspace/Command%20wing%20bar.md).
...
It is possible to activate the keyboard shortcuts by tapping the "Ins" key. Read more in the [Keyboard shortcuts topics](../Pages/Workspace/Keyboard%20shortcuts.md).
...
It is possible to connect 1 [grandMA2 onPC Command Wing](../Pages/Device%20Overview/MA%20onPC%20command%20wing.md) and 2 [grandMA2 onPC Fader Wings](../Pages/Device%20Overview/MA%20onPC%20fader%20wing.md) to 1 grandMA2 onPC.
...
It can be changed what block of 15 executors each wing should handle in the [Wing & Monitor Setup](../Pages/Console%20Settings/Wing%20&%20Monitor%20Setup.md). There is a green check mark in the detected hardware.
